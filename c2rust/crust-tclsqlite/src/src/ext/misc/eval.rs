...
pub struct EvalResult {
    ...
    pub zSep: *const ::core::ffi::c_char,
    pub szSep: ::core::ffi::c_int,
    pub nAlloc: sqlite3_int64,
    pub nUsed: sqlite3_int64,
}
...
unsafe extern "C" fn callback(
    ...
    mut colnames: *mut *mut ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    unsafe {
        let mut p: *mut EvalResult = pCtx as *mut EvalResult;
        ...
        while i < argc {
            let mut z: *const ::core::ffi::c_char = if !(*argv.offset(i as isize))
                .is_null()
            {
            ...
            let mut sz: size_t = strlen(z);
            if sz as ::core::ffi::c_longlong + (*p).nUsed as ::core::ffi::c_longlong
                + (*p).szSep as ::core::ffi::c_longlong + 1 as ::core::ffi::c_longlong
                > (*p).nAlloc
            {
                let mut zNew: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<
                    ::core::ffi::c_char,
                >();
                (*p).nAlloc = (((*p).nAlloc as ::core::ffi::c_longlong
                    * 2 as ::core::ffi::c_longlong) as ::core::ffi::c_ulonglong)
                    .wrapping_add(sz as ::core::ffi::c_ulonglong)
                    .wrapping_add((*p).szSep as ::core::ffi::c_ulonglong)
                    .wrapping_add(1 as ::core::ffi::c_ulonglong) as sqlite3_int64;
                zNew = (if (*p).nAlloc <= 0x7fffffff as ::core::ffi::c_longlong {
                    sqlite3_realloc64(
                ...
                if zNew.is_null() {
                    ...
                    memset(
                        ...
                        0 as ::core::ffi::c_int,
                        ::core::mem::size_of::<EvalResult>() as size_t,
                    );
                    return 1 as ::core::ffi::c_int;
                }
                (*p).z = zNew;
            }
            if (*p).nUsed > 0 as ::core::ffi::c_longlong {
                memcpy(
                    (*p).z.offset((*p).nUsed as isize) as *mut ::core::ffi::c_char
                        as *mut ::core::ffi::c_void,
                    (*p).zSep as *const ::core::ffi::c_void,
                    (*p).szSep as size_t,
                );
                (*p).nUsed += (*p).szSep as ::core::ffi::c_longlong;
            }
            memcpy(
                (*p).z.offset((*p).nUsed as isize) as *mut ::core::ffi::c_char
                    as *mut ::core::ffi::c_void,
            ...
            (*p).nUsed = ((*p).nUsed as ::core::ffi::c_ulonglong)
                .wrapping_add(sz as ::core::ffi::c_ulonglong) as sqlite3_int64
                as sqlite3_int64;
            i += 1;
        }
        return 0 as ::core::ffi::c_int;
...
unsafe extern "C" fn sqlEvalFunc(
    ...
    unsafe {
        ...
        let mut x: EvalResult = EvalResult {
            z: ::core::ptr::null_mut::<::core::ffi::c_char>(),
            zSep: ::core::ptr::null::<::core::ffi::c_char>(),
            szSep: 0,
            nAlloc: 0,
            nUsed: 0,
        };
        ...
        x.zSep = b" \0".as_ptr() as *const ::core::ffi::c_char;
        ...
        if argc > 1 as ::core::ffi::c_int {
            x.zSep = sqlite3_value_text(*argv.offset(1 as ::core::ffi::c_int as isize))
                as *const ::core::ffi::c_char;
            if x.zSep.is_null() {
                return;
            }
        }
        x.szSep = strlen(x.zSep) as ::core::ffi::c_int;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn sqlite3_eval_init(
    mut db: *mut sqlite3,
