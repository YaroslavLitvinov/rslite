...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct nextCharContext {
    pub db: *mut sqlite3,
    pub pStmt: *mut sqlite3_stmt,
    pub zPrefix: *const ::core::ffi::c_uchar,
    pub nPrefix: ::core::ffi::c_int,
    pub nAlloc: ::core::ffi::c_int,
    pub nUsed: ::core::ffi::c_int,
    pub aResult: *mut ::core::ffi::c_uint,
    pub mallocFailed: ::core::ffi::c_int,
    pub otherError: ::core::ffi::c_int,
}
...
unsafe extern "C" fn nextCharAppend(
    mut p: *mut nextCharContext,
    ...
    unsafe {
        ...
        while i < (*p).nUsed {
            if *(*p).aResult.offset(i as isize) == c {
                return;
            }
            i += 1;
        }
        if (*p).nUsed + 1 as ::core::ffi::c_int > (*p).nAlloc {
            let mut aNew: *mut ::core::ffi::c_uint = ::core::ptr::null_mut::<
                ::core::ffi::c_uint,
            >();
            let mut n: ::core::ffi::c_int = (*p).nAlloc * 2 as ::core::ffi::c_int
                + 30 as ::core::ffi::c_int;
            aNew = sqlite3_realloc64(
                (*p).aResult as *mut ::core::ffi::c_void,
                (n as usize)
                    .wrapping_mul(::core::mem::size_of::<::core::ffi::c_uint>() as usize)
                    as sqlite3_uint64,
            ) as *mut ::core::ffi::c_uint;
            if aNew.is_null() {
                (*p).mallocFailed = 1 as ::core::ffi::c_int;
                return;
            } else {
                (*p).aResult = aNew;
                (*p).nAlloc = n;
        ...
        let c2rust_fresh0 = (*p).nUsed;
        (*p).nUsed = (*p).nUsed + 1;
        *(*p).aResult.offset(c2rust_fresh0 as isize) = c;
    }
}
unsafe extern "C" fn writeUtf8(
    mut z: *mut ::core::ffi::c_uchar,
    mut c: ::core::ffi::c_uint,
) -> ::core::ffi::c_int {
    unsafe {
        if c < 0x80 as ::core::ffi::c_uint {
            *z.offset(0 as ::core::ffi::c_int as isize) = (c
                & 0xff as ::core::ffi::c_uint) as ::core::ffi::c_uchar;
            return 1 as ::core::ffi::c_int;
        }
        if c < 0x800 as ::core::ffi::c_uint {
            *z.offset(0 as ::core::ffi::c_int as isize) = (0xc0 as ::core::ffi::c_int
                + (c >> 6 as ::core::ffi::c_int & 0x1f as ::core::ffi::c_uint)
                    as ::core::ffi::c_uchar as ::core::ffi::c_int)
                as ::core::ffi::c_uchar;
            *z.offset(1 as ::core::ffi::c_int as isize) = (0x80 as ::core::ffi::c_int
                + (c & 0x3f as ::core::ffi::c_uint) as ::core::ffi::c_uchar
                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
            return 2 as ::core::ffi::c_int;
        }
        if c < 0x10000 as ::core::ffi::c_int as ::core::ffi::c_uint {
            *z.offset(0 as ::core::ffi::c_int as isize) = (0xe0 as ::core::ffi::c_int
            ...
            *z.offset(1 as ::core::ffi::c_int as isize) = (0x80 as ::core::ffi::c_int
                + (c >> 6 as ::core::ffi::c_int & 0x3f as ::core::ffi::c_uint)
                    as ::core::ffi::c_uchar as ::core::ffi::c_int)
                as ::core::ffi::c_uchar;
            *z.offset(2 as ::core::ffi::c_int as isize) = (0x80 as ::core::ffi::c_int
                + (c & 0x3f as ::core::ffi::c_uint) as ::core::ffi::c_uchar
                    as ::core::ffi::c_int) as ::core::ffi::c_uchar;
            return 3 as ::core::ffi::c_int;
        }
        *z.offset(0 as ::core::ffi::c_int as isize) = (0xf0 as ::core::ffi::c_int
            + (c >> 18 as ::core::ffi::c_int & 0x7 as ::core::ffi::c_uint)
                as ::core::ffi::c_uchar as ::core::ffi::c_int) as ::core::ffi::c_uchar;
        *z.offset(1 as ::core::ffi::c_int as isize) = (0x80 as ::core::ffi::c_int
        ...
        *z.offset(2 as ::core::ffi::c_int as isize) = (0x80 as ::core::ffi::c_int
            + (c >> 6 as ::core::ffi::c_int & 0x3f as ::core::ffi::c_uint)
                as ::core::ffi::c_uchar as ::core::ffi::c_int) as ::core::ffi::c_uchar;
        *z.offset(3 as ::core::ffi::c_int as isize) = (0x80 as ::core::ffi::c_int
            + (c & 0x3f as ::core::ffi::c_uint) as ::core::ffi::c_uchar
                as ::core::ffi::c_int) as ::core::ffi::c_uchar;
        return 4 as ::core::ffi::c_int;
    }
}
unsafe extern "C" fn readUtf8(
    mut z: *const ::core::ffi::c_uchar,
    mut pOut: *mut ::core::ffi::c_uint,
) -> ::core::ffi::c_int {
    unsafe {
        static mut validBits: [::core::ffi::c_uchar; 64] = [
        ...
        let mut c: ::core::ffi::c_uint = *z.offset(0 as ::core::ffi::c_int as isize)
            as ::core::ffi::c_uint;
        if c < 0xc0 as ::core::ffi::c_uint {
            *pOut = c;
            ...
            c = validBits[c.wrapping_sub(0xc0 as ::core::ffi::c_uint) as usize]
                as ::core::ffi::c_uint;
            while *z.offset(n as isize) as ::core::ffi::c_int
                ...
                c = (c << 6 as ::core::ffi::c_int)
                    .wrapping_add(
                        (0x3f as ::core::ffi::c_int
                            & *z.offset(c2rust_fresh1 as isize) as ::core::ffi::c_int)
                            as ::core::ffi::c_uint,
                    );
            }
            if c < 0x80 as ::core::ffi::c_uint
...
unsafe extern "C" fn findNextChars(mut p: *mut nextCharContext) {
    unsafe {
        let mut cPrev: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        let mut zPrev: [::core::ffi::c_uchar; 8] = [0; 8];
        ...
        loop {
            sqlite3_bind_text(
                (*p).pStmt,
                1 as ::core::ffi::c_int,
                (*p).zPrefix as *mut ::core::ffi::c_char,
                (*p).nPrefix,
                SQLITE_STATIC,
            );
            n = writeUtf8(
                &raw mut zPrev as *mut ::core::ffi::c_uchar,
                cPrev.wrapping_add(1 as ::core::ffi::c_uint),
            );
            sqlite3_bind_text(
                (*p).pStmt,
                2 as ::core::ffi::c_int,
                &raw mut zPrev as *mut ::core::ffi::c_uchar as *mut ::core::ffi::c_char,
                n,
                SQLITE_STATIC,
            );
            ...
            if rc == SQLITE_DONE {
                ...
                let mut zOut: *const ::core::ffi::c_uchar = sqlite3_column_text(
                    (*p).pStmt,
                    0 as ::core::ffi::c_int,
                );
                let mut cNext: ::core::ffi::c_uint = 0;
                n = readUtf8(zOut.offset((*p).nPrefix as isize), &raw mut cNext);
                sqlite3_reset((*p).pStmt);
...
unsafe extern "C" fn nextCharFunc(
    mut context: *mut sqlite3_context,
    mut argc: ::core::ffi::c_int,
    mut argv: *mut *mut sqlite3_value,
) {
    unsafe {
        let mut c: nextCharContext = nextCharContext {
            db: ::core::ptr::null_mut::<sqlite3>(),
            pStmt: ::core::ptr::null_mut::<sqlite3_stmt>(),
            zPrefix: ::core::ptr::null::<::core::ffi::c_uchar>(),
            nPrefix: 0,
            nAlloc: 0,
            nUsed: 0,
            aResult: ::core::ptr::null_mut::<::core::ffi::c_uint>(),
            mallocFailed: 0,
            otherError: 0,
        };
        let mut zTable: *const ::core::ffi::c_uchar = sqlite3_value_text(
            *argv.offset(1 as ::core::ffi::c_int as isize),
        );
        let mut zField: *const ::core::ffi::c_uchar = sqlite3_value_text(
            *argv.offset(2 as ::core::ffi::c_int as isize),
        );
        let mut zWhere: *const ::core::ffi::c_uchar = ::core::ptr::null::<
            ::core::ffi::c_uchar,
        >();
        let mut zCollName: *const ::core::ffi::c_uchar = ::core::ptr::null::<
            ::core::ffi::c_uchar,
        >();
        let mut zWhereClause: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<
            ::core::ffi::c_char,
        >();
        ...
        memset(
            ...
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<nextCharContext>() as size_t,
        );
        c.db = sqlite3_context_db_handle(context);
        c.zPrefix = sqlite3_value_text(*argv.offset(0 as ::core::ffi::c_int as isize));
        c.nPrefix = sqlite3_value_bytes(*argv.offset(0 as ::core::ffi::c_int as isize));
        if zTable.is_null() || zField.is_null() || c.zPrefix.is_null() {
            return;
        }
        if argc >= 4 as ::core::ffi::c_int
            && {
                zWhere = sqlite3_value_text(
                    *argv.offset(3 as ::core::ffi::c_int as isize),
                );
                !zWhere.is_null()
            }
            && *zWhere.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                != 0 as ::core::ffi::c_int
        {
            zWhereClause = sqlite3_mprintf(
                b"AND (%s)\0".as_ptr() as *const ::core::ffi::c_char,
                zWhere,
            );
            if zWhereClause.is_null() {
                sqlite3_result_error_nomem(context);
                return;
            }
        } else {
            zWhereClause = b"\0".as_ptr() as *const ::core::ffi::c_char
                as *mut ::core::ffi::c_char;
        }
        if argc >= 5 as ::core::ffi::c_int
            && {
                zCollName = sqlite3_value_text(
                    *argv.offset(4 as ::core::ffi::c_int as isize),
                );
                !zCollName.is_null()
            }
            && *zCollName.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                != 0 as ::core::ffi::c_int
        {
            zColl = sqlite3_mprintf(
                b"collate \"%w\"\0".as_ptr() as *const ::core::ffi::c_char,
                zCollName,
            );
            if zColl.is_null() {
                sqlite3_result_error_nomem(context);
                if *zWhereClause.offset(0 as ::core::ffi::c_int as isize) != 0 {
                    sqlite3_free(zWhereClause as *mut ::core::ffi::c_void);
                }
                return;
            }
        } else {
            zColl = b"\0".as_ptr() as *const ::core::ffi::c_char
                as *mut ::core::ffi::c_char;
        }
        zSql = sqlite3_mprintf(
            b"SELECT %s FROM %s WHERE %s>=(?1 || ?2) %s   AND %s<=(?1 || char(1114111)) %s   %s ORDER BY 1 %s ASC LIMIT 1\0"
        ...
        if *zColl.offset(0 as ::core::ffi::c_int as isize) != 0 {
            sqlite3_free(zColl as *mut ::core::ffi::c_void);
        }
        if zSql.is_null() {
            sqlite3_result_error_nomem(context);
            return;
        ...
        findNextChars(&raw mut c);
        if c.mallocFailed != 0 {
            sqlite3_result_error_nomem(context);
        } else {
            let mut pRes: *mut ::core::ffi::c_uchar = ::core::ptr::null_mut::<
                ::core::ffi::c_uchar,
            >();
            pRes = sqlite3_malloc64(
                (c.nUsed * 4 as ::core::ffi::c_int + 1 as ::core::ffi::c_int)
                    as sqlite3_uint64,
            ...
            if pRes.is_null() {
                ...
                while i < c.nUsed {
                    n
                        += writeUtf8(
                            pRes.offset(n as isize),
                            *c.aResult.offset(i as isize),
                        );
                    i += 1;
                }
                *pRes.offset(n as isize) = 0 as ::core::ffi::c_uchar;
                sqlite3_result_text(
                    context,
                    pRes as *const ::core::ffi::c_char,
                    n,
                    Some(
                        sqlite3_free
        ...
        sqlite3_free(c.aResult as *mut ::core::ffi::c_void);
    }
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn sqlite3_nextchar_init(
    mut db: *mut sqlite3,
    ...
    unsafe {
        ...
        rc = sqlite3_create_function(
            db,
            b"next_char\0".as_ptr() as *const ::core::ffi::c_char,
            3 as ::core::ffi::c_int,
