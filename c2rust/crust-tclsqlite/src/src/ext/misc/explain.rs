...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct explain_vtab {
    pub base: sqlite3_vtab,
    pub db: *mut sqlite3,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct explain_cursor {
    pub base: sqlite3_vtab_cursor,
    pub db: *mut sqlite3,
    pub zSql: *mut ::core::ffi::c_char,
    pub pExplain: *mut sqlite3_stmt,
...
unsafe extern "C" fn explainConnect(
    mut db: *mut sqlite3,
    ...
    unsafe {
        let mut pNew: *mut explain_vtab = ::core::ptr::null_mut::<explain_vtab>();
        let mut rc: ::core::ffi::c_int = 0;
        rc = sqlite3_declare_vtab(
            db,
            b"CREATE TABLE x(addr,opcode,p1,p2,p3,p4,p5,comment,sql HIDDEN)\0".as_ptr()
                as *const ::core::ffi::c_char,
        );
        if rc == SQLITE_OK {
            pNew = sqlite3_malloc(
                ::core::mem::size_of::<explain_vtab>() as ::core::ffi::c_int,
            ) as *mut explain_vtab;
            *ppVtab = pNew as *mut sqlite3_vtab;
            ...
            memset(
                ...
                0 as ::core::ffi::c_int,
                ::core::mem::size_of::<explain_vtab>() as size_t,
            );
            (*pNew).db = db;
        }
        return rc;
...
pub const EXPLN_COLUMN_SQL: ::core::ffi::c_int = 8 as ::core::ffi::c_int;
unsafe extern "C" fn explainDisconnect(
...
unsafe extern "C" fn explainOpen(
    mut p: *mut sqlite3_vtab,
    mut ppCursor: *mut *mut sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut explain_cursor = ::core::ptr::null_mut::<explain_cursor>();
        pCur = sqlite3_malloc(
            ::core::mem::size_of::<explain_cursor>() as ::core::ffi::c_int,
        ...
        memset(
            ...
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<explain_cursor>() as size_t,
        );
        (*pCur).db = (*(p as *mut explain_vtab)).db;
        *ppCursor = &raw mut (*pCur).base;
        return SQLITE_OK;
    }
}
unsafe extern "C" fn explainClose(
    mut cur: *mut sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut explain_cursor = cur as *mut explain_cursor;
        sqlite3_finalize((*pCur).pExplain);
        sqlite3_free((*pCur).zSql as *mut ::core::ffi::c_void);
        sqlite3_free(pCur as *mut ::core::ffi::c_void);
        return SQLITE_OK;
    }
}
unsafe extern "C" fn explainNext(
    mut cur: *mut sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut explain_cursor = cur as *mut explain_cursor;
        (*pCur).rc = sqlite3_step((*pCur).pExplain);
        if (*pCur).rc != SQLITE_DONE && (*pCur).rc != SQLITE_ROW {
            return (*pCur).rc;
        }
        return SQLITE_OK;
    }
}
unsafe extern "C" fn explainColumn(
    mut cur: *mut sqlite3_vtab_cursor,
...
unsafe extern "C" fn explainRowid(
    mut cur: *mut sqlite3_vtab_cursor,
    mut pRowid: *mut sqlite_int64,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut explain_cursor = cur as *mut explain_cursor;
        *pRowid = sqlite3_column_int64((*pCur).pExplain, 0 as ::core::ffi::c_int)
            as sqlite_int64;
        return SQLITE_OK;
    }
}
unsafe extern "C" fn explainEof(
    mut cur: *mut sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut explain_cursor = cur as *mut explain_cursor;
        return ((*pCur).rc != SQLITE_ROW) as ::core::ffi::c_int;
    }
}
unsafe extern "C" fn explainFilter(
    ...
    unsafe {
        let mut pCur: *mut explain_cursor = pVtabCursor as *mut explain_cursor;
        let mut zSql: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<
            ::core::ffi::c_char,
        >();
        let mut rc: ::core::ffi::c_int = 0;
        sqlite3_finalize((*pCur).pExplain);
        (*pCur).pExplain = ::core::ptr::null_mut::<sqlite3_stmt>();
        ...
        sqlite3_free((*pCur).zSql as *mut ::core::ffi::c_void);
        (*pCur).zSql = sqlite3_mprintf(
            b"%s\0".as_ptr() as *const ::core::ffi::c_char,
            sqlite3_value_text(*argv.offset(0 as ::core::ffi::c_int as isize)),
        );
        if !(*pCur).zSql.is_null() {
            zSql = sqlite3_mprintf(
                b"EXPLAIN %s\0".as_ptr() as *const ::core::ffi::c_char,
                (*pCur).zSql,
            );
        }
        if zSql.is_null() {
        ...
        if rc != 0 {
            ...
            (*pCur).pExplain = ::core::ptr::null_mut::<sqlite3_stmt>();
            sqlite3_free((*pCur).zSql as *mut ::core::ffi::c_void);
            (*pCur).zSql = ::core::ptr::null_mut::<::core::ffi::c_char>();
        } else {
            (*pCur).rc = sqlite3_step((*pCur).pExplain);
            rc = if (*pCur).rc == SQLITE_DONE || (*pCur).rc == SQLITE_ROW {
                SQLITE_OK
            } else {
                (*pCur).rc
            };
...
unsafe extern "C" fn explainBestIndex(
    ...
    unsafe {
        ...
        while i < (*pIdxInfo).nConstraint {
            ...
            if !((*p).iColumn != EXPLN_COLUMN_SQL) {
                if (*p).usable == 0 {
                    unusable = 1 as ::core::ffi::c_int;
                } else if (*p).op as ::core::ffi::c_int == SQLITE_INDEX_CONSTRAINT_EQ {
                    idx = i;
                }
            }
            i += 1;
...
static mut explainModule: sqlite3_module = unsafe {
    sqlite3_module {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn sqlite3ExplainVtabInit(
    mut db: *mut sqlite3,
) -> ::core::ffi::c_int {
    unsafe {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn sqlite3_explain_init(
    mut db: *mut sqlite3,
