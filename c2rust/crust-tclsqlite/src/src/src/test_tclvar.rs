...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct tclvar_vtab {
    pub base: sqlite3_vtab,
    pub interp: *mut Tcl_Interp,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct tclvar_cursor {
    pub base: sqlite3_vtab_cursor,
    pub pList1: *mut Tcl_Obj,
    pub pList2: *mut Tcl_Obj,
...
pub const TCLVAR_NAME_EQ: ::core::ffi::c_int = 101;
pub const TCLVAR_NAME_MATCH: ::core::ffi::c_int = 109;
pub const TCLVAR_VALUE_GLOB: ::core::ffi::c_int = 103;
pub const TCLVAR_VALUE_REGEXP: ::core::ffi::c_int = 114;
pub const TCLVAR_VALUE_LIKE: ::core::ffi::c_int = 108;
unsafe extern "C" fn tclvarConnect(
    mut db: *mut sqlite3,
    ...
    unsafe {
        let mut pVtab: *mut tclvar_vtab = ::core::ptr::null_mut::<tclvar_vtab>();
        static mut zSchema: [::core::ffi::c_char; 100] = unsafe {
            ::core::mem::transmute::<
                [u8; 100],
                [::core::ffi::c_char; 100],
            >(
                *b"CREATE TABLE x(  name TEXT,  arrayname TEXT,  value TEXT,  fullname TEXT PRIMARY KEY) WITHOUT ROWID\0",
            )
        };
        pVtab = sqlite3MallocZero(::core::mem::size_of::<tclvar_vtab>() as u64_0)
            as *mut tclvar_vtab;
        if pVtab.is_null() {
            return SQLITE_NOMEM;
        }
        *ppVtab = &raw mut (*pVtab).base;
        (*pVtab).interp = pAux as *mut Tcl_Interp;
        sqlite3_declare_vtab(db, &raw const zSchema as *const ::core::ffi::c_char);
        return SQLITE_OK;
    }
}
unsafe extern "C" fn tclvarDisconnect(
...
unsafe extern "C" fn tclvarOpen(
    mut pVTab: *mut sqlite3_vtab,
    mut ppCursor: *mut *mut sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut tclvar_cursor = ::core::ptr::null_mut::<tclvar_cursor>();
        pCur = sqlite3MallocZero(::core::mem::size_of::<tclvar_cursor>() as u64_0)
            as *mut tclvar_cursor;
        *ppCursor = &raw mut (*pCur).base;
        return SQLITE_OK;
    }
}
unsafe extern "C" fn tclvarClose(
    mut cur: *mut sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut tclvar_cursor = cur as *mut tclvar_cursor;
        if !(*pCur).pList1.is_null() {
            let mut _objPtr: *mut Tcl_Obj = (*pCur).pList1;
        ...
        if !(*pCur).pList2.is_null() {
            let mut _objPtr_0: *mut Tcl_Obj = (*pCur).pList2;
...
unsafe extern "C" fn next2(
    ...
    unsafe {
        ...
        if !pObj.is_null() {
            if (*pCur).pList2.is_null() {
                p = Tcl_NewStringObj(
                    b"array names\0".as_ptr() as *const ::core::ffi::c_char,
                    -1 as ::core::ffi::c_int,
                );
                (*p).refCount += 1;
                Tcl_ListObjAppendElement(::core::ptr::null_mut::<Tcl_Interp>(), p, pObj);
                ...
                if (*pCur).i2 >= n {
                    ...
                    (*pCur).pList2 = ::core::ptr::null_mut::<Tcl_Obj>();
                    (*pCur).i2 = 0 as ::core::ffi::c_int;
...
unsafe extern "C" fn tclvarNext(
    ...
    unsafe {
        ...
        let mut pCur: *mut tclvar_cursor = cur as *mut tclvar_cursor;
        let mut interp: *mut Tcl_Interp = (*((*cur).pVtab as *mut tclvar_vtab)).interp;
        Tcl_ListObjLength(
            ::core::ptr::null_mut::<Tcl_Interp>(),
            (*pCur).pList1,
            &raw mut n,
        );
        while ok == 0 && (*pCur).i1 < n {
            Tcl_ListObjIndex(
                ::core::ptr::null_mut::<Tcl_Interp>(),
                (*pCur).pList1,
                (*pCur).i1,
...
unsafe extern "C" fn tclvarFilter(
    ...
    unsafe {
        let mut pCur: *mut tclvar_cursor = pVtabCursor as *mut tclvar_cursor;
        let mut interp: *mut Tcl_Interp = (*((*pVtabCursor).pVtab as *mut tclvar_vtab))
            .interp;
        let mut p: *mut Tcl_Obj = Tcl_NewStringObj(
            b"tclvar_filter_cmd\0".as_ptr() as *const ::core::ffi::c_char,
            -1 as ::core::ffi::c_int,
        );
        let mut zEq: *const ::core::ffi::c_char = b"\0".as_ptr()
            as *const ::core::ffi::c_char;
        let mut zMatch: *const ::core::ffi::c_char = b"\0".as_ptr()
            as *const ::core::ffi::c_char;
        let mut zGlob: *const ::core::ffi::c_char = b"\0".as_ptr()
            as *const ::core::ffi::c_char;
        let mut zRegexp: *const ::core::ffi::c_char = b"\0".as_ptr()
            as *const ::core::ffi::c_char;
        let mut zLike: *const ::core::ffi::c_char = b"\0".as_ptr()
            as *const ::core::ffi::c_char;
        let mut i: ::core::ffi::c_int = 0;
        i = 0 as ::core::ffi::c_int;
        while *idxStr.offset(i as isize) != 0 {
            match *idxStr.offset(i as isize) as ::core::ffi::c_int {
                TCLVAR_NAME_EQ => {
                    zEq = sqlite3_value_text(*argv.offset(i as isize))
                        as *const ::core::ffi::c_char;
                }
                TCLVAR_NAME_MATCH => {
                    zMatch = sqlite3_value_text(*argv.offset(i as isize))
                        as *const ::core::ffi::c_char;
                }
                TCLVAR_VALUE_GLOB => {
                    zGlob = sqlite3_value_text(*argv.offset(i as isize))
                        as *const ::core::ffi::c_char;
                }
                TCLVAR_VALUE_REGEXP => {
                    zRegexp = sqlite3_value_text(*argv.offset(i as isize))
                        as *const ::core::ffi::c_char;
                }
                TCLVAR_VALUE_LIKE => {
                    zLike = sqlite3_value_text(*argv.offset(i as isize))
                        as *const ::core::ffi::c_char;
                }
                _ => {}
            }
        ...
        Tcl_ListObjAppendElement(
            ::core::ptr::null_mut::<Tcl_Interp>(),
            p,
            Tcl_NewStringObj(zEq, -1 as ::core::ffi::c_int),
        );
        Tcl_ListObjAppendElement(
            ::core::ptr::null_mut::<Tcl_Interp>(),
            p,
            Tcl_NewStringObj(zMatch, -1 as ::core::ffi::c_int),
        );
        Tcl_ListObjAppendElement(
            ::core::ptr::null_mut::<Tcl_Interp>(),
            p,
            Tcl_NewStringObj(zGlob, -1 as ::core::ffi::c_int),
        );
        Tcl_ListObjAppendElement(
            ::core::ptr::null_mut::<Tcl_Interp>(),
            p,
            Tcl_NewStringObj(zRegexp, -1 as ::core::ffi::c_int),
        );
        Tcl_ListObjAppendElement(
            ::core::ptr::null_mut::<Tcl_Interp>(),
            p,
            Tcl_NewStringObj(zLike, -1 as ::core::ffi::c_int),
        );
        Tcl_EvalObjEx(interp, p, TCL_EVAL_GLOBAL);
        if !(*pCur).pList1.is_null() {
            let mut _objPtr: *mut Tcl_Obj = (*pCur).pList1;
        ...
        if !(*pCur).pList2.is_null() {
            let mut _objPtr_0: *mut Tcl_Obj = (*pCur).pList2;
            let c2rust_fresh5 = (*_objPtr_0).refCount;
            (*_objPtr_0).refCount = (*_objPtr_0).refCount - 1;
        ...
        (*pCur).i1 = 0 as ::core::ffi::c_int;
        (*pCur).i2 = 0 as ::core::ffi::c_int;
        (*pCur).pList1 = Tcl_GetObjResult(interp);
        (*(*pCur).pList1).refCount += 1;
        let mut _objPtr_1: *mut Tcl_Obj = p;
        let c2rust_fresh6 = (*_objPtr_1).refCount;
...
unsafe extern "C" fn tclvarColumn(
    mut cur: *mut sqlite3_vtab_cursor,
    mut ctx: *mut sqlite3_context,
    mut i: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    unsafe {
        let mut p1: *mut Tcl_Obj = ::core::ptr::null_mut::<Tcl_Obj>();
        let mut p2: *mut Tcl_Obj = ::core::ptr::null_mut::<Tcl_Obj>();
        let mut z1: *const ::core::ffi::c_char = ::core::ptr::null::<
            ::core::ffi::c_char,
        >();
        let mut z2: *const ::core::ffi::c_char = b"\0".as_ptr()
            as *const ::core::ffi::c_char;
        let mut pCur: *mut tclvar_cursor = cur as *mut tclvar_cursor;
        let mut interp: *mut Tcl_Interp = (*((*cur).pVtab as *mut tclvar_vtab)).interp;
        Tcl_ListObjIndex(interp, (*pCur).pList1, (*pCur).i1, &raw mut p1);
        Tcl_ListObjIndex(interp, (*pCur).pList2, (*pCur).i2, &raw mut p2);
        z1 = Tcl_GetString(p1);
        if !p2.is_null() {
            z2 = Tcl_GetString(p2);
        }
        match i {
            ...
            2 => {
                let mut pVal: *mut Tcl_Obj = Tcl_GetVar2Ex(
                    interp,
                    z1,
            ...
            3 => {
                let mut z3: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<
                    ::core::ffi::c_char,
                >();
                if !p2.is_null() {
                    z3 = sqlite3_mprintf(
...
unsafe extern "C" fn tclvarRowid(
    mut cur: *mut sqlite3_vtab_cursor,
...
unsafe extern "C" fn tclvarEof(mut cur: *mut sqlite3_vtab_cursor) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut tclvar_cursor = cur as *mut tclvar_cursor;
        return if !(*pCur).pList2.is_null() {
            0 as ::core::ffi::c_int
        } else {
            1 as ::core::ffi::c_int
        };
...
unsafe extern "C" fn tclvarAddToIdxstr(
    mut zStr: *mut ::core::ffi::c_char,
    mut x: ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    unsafe {
        let mut i: ::core::ffi::c_int = 0;
        i = 0 as ::core::ffi::c_int;
        while *zStr.offset(i as isize) != 0 {
            if *zStr.offset(i as isize) as ::core::ffi::c_int == x as ::core::ffi::c_int
            {
                return 1 as ::core::ffi::c_int;
            }
            i += 1;
        }
        *zStr.offset(i as isize) = x;
        *zStr.offset((i + 1 as ::core::ffi::c_int) as isize) = '\0' as i32
            as ::core::ffi::c_char;
        return 0 as ::core::ffi::c_int;
    }
}
unsafe extern "C" fn tclvarSetOmit(mut interp: *mut Tcl_Interp) -> ::core::ffi::c_int {
    unsafe {
        ...
        rc = Tcl_Eval(
            interp,
            b"expr {[info exists ::tclvar_set_omit] && $::tclvar_set_omit}\0".as_ptr()
                as *const ::core::ffi::c_char,
        );
        if rc == TCL_OK {
        ...
        return (rc == TCL_OK && res != 0) as ::core::ffi::c_int;
    }
}
unsafe extern "C" fn tclvarBestIndex(
    mut tab: *mut sqlite3_vtab,
    mut pIdxInfo: *mut sqlite3_index_info,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pTab: *mut tclvar_vtab = tab as *mut tclvar_vtab;
        let mut ii: ::core::ffi::c_int = 0;
        let mut zStr: *mut ::core::ffi::c_char = sqlite3_malloc(32 as ::core::ffi::c_int)
            as *mut ::core::ffi::c_char;
        let mut iStr: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
        if zStr.is_null() {
            return SQLITE_NOMEM;
        }
        *zStr.offset(0 as ::core::ffi::c_int as isize) = '\0' as i32
            as ::core::ffi::c_char;
            ...
            if (*pCons).usable != 0 {
                    ...
                    && (*pCons).iColumn == 0 as ::core::ffi::c_int
                {
                    if 0 as ::core::ffi::c_int
                        == tclvarAddToIdxstr(zStr, TCLVAR_NAME_EQ as ::core::ffi::c_char)
                    {
                        iStr += 1;
                    ...
                    && (*pCons).iColumn == 0 as ::core::ffi::c_int
                {
                    if 0 as ::core::ffi::c_int
                        == tclvarAddToIdxstr(
                            zStr,
                            TCLVAR_NAME_MATCH as ::core::ffi::c_char,
                        )
                    {
                        iStr += 1;
                        (*pUsage).argvIndex = iStr;
                ...
                if (*pCons).op as ::core::ffi::c_int == SQLITE_INDEX_CONSTRAINT_GLOB
                    && (*pCons).iColumn == 2 as ::core::ffi::c_int
                {
                    if 0 as ::core::ffi::c_int
                        == tclvarAddToIdxstr(
                            zStr,
                            TCLVAR_VALUE_GLOB as ::core::ffi::c_char,
                        )
                    {
                        iStr += 1;
                        (*pUsage).argvIndex = iStr;
                ...
                if (*pCons).op as ::core::ffi::c_int == SQLITE_INDEX_CONSTRAINT_REGEXP
                    && (*pCons).iColumn == 2 as ::core::ffi::c_int
                {
                    if 0 as ::core::ffi::c_int
                        == tclvarAddToIdxstr(
                            zStr,
                            TCLVAR_VALUE_REGEXP as ::core::ffi::c_char,
                        )
                    {
                        iStr += 1;
                        (*pUsage).argvIndex = iStr;
                ...
                if (*pCons).op as ::core::ffi::c_int == SQLITE_INDEX_CONSTRAINT_LIKE
                    && (*pCons).iColumn == 2 as ::core::ffi::c_int
                {
                    if 0 as ::core::ffi::c_int
                        == tclvarAddToIdxstr(
                            zStr,
                            TCLVAR_VALUE_LIKE as ::core::ffi::c_char,
                        )
                    {
                        iStr += 1;
                        (*pUsage).argvIndex = iStr;
...
unsafe extern "C" fn tclvarUpdate(
    mut tab: *mut sqlite3_vtab,
    mut argc: ::core::ffi::c_int,
    mut argv: *mut *mut sqlite3_value,
    mut pRowid: *mut sqlite_int64,
    ...
    unsafe {
        ...
        if argc == 1 as ::core::ffi::c_int {
            let mut zVar: *const ::core::ffi::c_char = sqlite3_value_text(
        ...
        if sqlite3_value_type(*argv.offset(0 as ::core::ffi::c_int as isize))
            == SQLITE_NULL
        {
            let mut zValue: *const ::core::ffi::c_char = sqlite3_value_text(
                *argv.offset(4 as ::core::ffi::c_int as isize),
            ) as *const ::core::ffi::c_char;
            let mut zName: *const ::core::ffi::c_char = ::core::ptr::null::<
                ::core::ffi::c_char,
            >();
            if sqlite3_value_type(*argv.offset(5 as ::core::ffi::c_int as isize))
                != SQLITE_TEXT
            {
                (*tab).zErrMsg = sqlite3_mprintf(
                    b"the 'fullname' column must be TEXT\0".as_ptr()
                        as *const ::core::ffi::c_char,
                );
                return SQLITE_ERROR;
            }
            zName = sqlite3_value_text(*argv.offset(5 as ::core::ffi::c_int as isize))
                as *const ::core::ffi::c_char;
            if !zValue.is_null() {
                Tcl_SetVar2(
                    (*pTab).interp,
        ...
        if sqlite3_value_type(*argv.offset(0 as ::core::ffi::c_int as isize))
            ...
            && sqlite3_value_type(*argv.offset(1 as ::core::ffi::c_int as isize))
                == SQLITE_TEXT
        {
            let mut zOldName: *const ::core::ffi::c_char = sqlite3_value_text(
                *argv.offset(0 as ::core::ffi::c_int as isize),
            ) as *const ::core::ffi::c_char;
            let mut zNewName: *const ::core::ffi::c_char = sqlite3_value_text(
                *argv.offset(1 as ::core::ffi::c_int as isize),
            ) as *const ::core::ffi::c_char;
            let mut zValue_0: *const ::core::ffi::c_char = sqlite3_value_text(
                *argv.offset(4 as ::core::ffi::c_int as isize),
            ) as *const ::core::ffi::c_char;
            if strcmp(zOldName, zNewName) != 0 as ::core::ffi::c_int
                || zValue_0.is_null()
            {
                Tcl_UnsetVar2(
                    (*pTab).interp,
        ...
        (*tab).zErrMsg = sqlite3_mprintf(
            b"prohibited TCL variable change\0".as_ptr() as *const ::core::ffi::c_char,
        );
        return SQLITE_ERROR;
    }
}
static mut tclvarModule: sqlite3_module = unsafe {
    sqlite3_module {
...
unsafe extern "C" fn register_tclvar_module(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn Sqlitetesttclvar_Init(
    mut interp: *mut Tcl_Interp,
) -> ::core::ffi::c_int {
    unsafe {
        static mut aObjCmd: [C2Rust_Unnamed_25; 1] = unsafe {
            [
                C2Rust_Unnamed_25 {
                    zName: b"register_tclvar_module\0".as_ptr()
