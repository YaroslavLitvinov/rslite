...
pub unsafe extern "C" fn sqlite3_exec(
            ...
            loop {
                ...
                if xCallback.is_some()
                    && (SQLITE_ROW == rc
                        || SQLITE_DONE == rc
                            && callbackIsInit == 0
                            && (*db).flags & SQLITE_NullCallback as u64_0 != 0)
                {
                    if callbackIsInit == 0 {
                        ...
                        while i < nCol {
                            ...
                            *fresh0 = sqlite3_column_name(pStmt, i) as *mut ::core::ffi::c_char;
                            i += 1;
                        }
                    ...
                    if rc == SQLITE_ROW {
                        ...
                        while i < nCol {
                            ...
                            *fresh1 = sqlite3_column_text(pStmt, i) as *mut ::core::ffi::c_char;
    ...
    if rc != SQLITE_OK && !pzErrMsg.is_null() {
        *pzErrMsg = sqlite3DbStrDup(::core::ptr::null_mut::<sqlite3>(), sqlite3_errmsg(db));
        if (*pzErrMsg).is_null() {
