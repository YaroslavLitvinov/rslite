...
pub unsafe extern "C" fn sqlite3_exec(
        ...
        && *zSql.offset(0 as isize) as ::core::ffi::c_int != 0
    {
        ...
        if pStmt.is_null() {
            ...
            loop {
                ...
                if xCallback.is_some()
                    && (crate::sqlite3_h::SQLITE_ROW == rc
                        || crate::sqlite3_h::SQLITE_DONE == rc
                            && callbackIsInit == 0
                            && (*db).flags & crate::sqliteInt_h::SQLITE_NullCallback as crate::src::ext::rtree::rtree::u64_0 != 0)
                {
                    if callbackIsInit == 0 {
                        ...
                        while i < nCol {
                            ...
                            *fresh1 = crate::src::src::vdbeapi::sqlite3_column_text(pStmt, i) as *mut ::core::ffi::c_char;
                            if (*azVals.offset(i as isize)).is_null()
                                && crate::src::src::vdbeapi::sqlite3_column_type(pStmt, i) != crate::sqlite3_h::SQLITE_NULL
                            {
                        ...
                        != 0
                    {
                        ...
                        crate::src::src::vdbeaux::sqlite3VdbeFinalize(pStmt as *mut crate::vdbeInt_h::Vdbe);
                        pStmt = ::core::ptr::null_mut::<crate::sqlite3_h::sqlite3_stmt>();
                        crate::src::src::util::sqlite3Error(db as *mut crate::sqliteInt_h::sqlite3, crate::sqlite3_h::SQLITE_ABORT);
                        break 's_32;
                    }
                }
                if !(rc != crate::sqlite3_h::SQLITE_ROW) {
                ...
                rc = crate::src::src::vdbeaux::sqlite3VdbeFinalize(pStmt as *mut crate::vdbeInt_h::Vdbe);
                pStmt = ::core::ptr::null_mut::<crate::sqlite3_h::sqlite3_stmt>();
                zSql = zLeftover;
            ...
            crate::src::src::malloc::sqlite3DbFree(db as *mut crate::sqliteInt_h::sqlite3, azCols as *mut ::core::ffi::c_void);
    ...
    if rc != crate::sqlite3_h::SQLITE_OK && !pzErrMsg.is_null() {
        *pzErrMsg = crate::src::src::malloc::sqlite3DbStrDup(::core::ptr::null_mut::<crate::sqliteInt_h::sqlite3>() as
    *mut crate::sqliteInt_h::sqlite3, crate::src::src::main::sqlite3_errmsg(db as *mut crate::sqliteInt_h::sqlite3));
        if (*pzErrMsg).is_null() {
