...
pub unsafe extern "C" fn sqlite3_complete16(
    ...
    *mut crate::sqliteInt_h::sqlite3);
    ...
    zSql8 = crate::src::src::vdbemem::sqlite3ValueText(pVal, crate::sqlite3_h::SQLITE_UTF8 as crate::src::ext::rtree::rtree::u8_0) as *const ::core::ffi::c_char;
    if !zSql8.is_null() {
