...
pub const BITVEC_NELEM: usize = BITVEC_USIZE.wrapping_div(::core::mem::size_of::<u8_0>() as usize);
pub const BITVEC_NBIT: usize = BITVEC_NELEM.wrapping_mul(BITVEC_SZELEM as usize);
pub const BITVEC_NINT: usize = BITVEC_USIZE.wrapping_div(::core::mem::size_of::<u32_0>() as usize);
pub const BITVEC_MXHASH: usize = BITVEC_NINT.wrapping_div(2 as usize);
pub const BITVEC_NPTR: u32_0 =
    BITVEC_USIZE.wrapping_div(::core::mem::size_of::<*mut Bitvec>() as usize) as u32_0;
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3BitvecTestNotNull(
    ...
    if (*p).iSize as usize <= BITVEC_NBIT {
        return ((*p).u.aBitmap[i.wrapping_div(BITVEC_SZELEM as u32_0) as usize]
            as ::core::ffi::c_int
            & (1 as ::core::ffi::c_int) << (i & (BITVEC_SZELEM - 1 as ::core::ffi::c_int) as u32_0)
            != 0 as ::core::ffi::c_int) as ::core::ffi::c_int;
    } else {
        let fresh0 = i;
        i = i.wrapping_add(1);
        let mut h: u32_0 =
            (fresh0.wrapping_mul(1 as u32_0) as usize).wrapping_rem(BITVEC_NINT) as u32_0;
        while (*p).u.aHash[h as usize] != 0 {
            if (*p).u.aHash[h as usize] == i {
                return 1 as ::core::ffi::c_int;
            }
            h = (h.wrapping_add(1 as u32_0) as usize).wrapping_rem(BITVEC_NINT) as u32_0;
        }
        return 0 as ::core::ffi::c_int;
    };
}
#[no_mangle]
pub unsafe extern "C" fn sqlite3BitvecTest(mut p: *mut Bitvec, mut i: u32_0) -> ::core::ffi::c_int {
    return (!p.is_null() && sqlite3BitvecTestNotNull(p, i) != 0) as ::core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn sqlite3BitvecSet(mut p: *mut Bitvec, mut i: u32_0) -> ::core::ffi::c_int {
    ...
    if (*p).iSize as usize <= BITVEC_NBIT {
        (*p).u.aBitmap[i.wrapping_div(BITVEC_SZELEM as u32_0) as usize] = ((*p).u.aBitmap
            [i.wrapping_div(BITVEC_SZELEM as u32_0) as usize]
            as ::core::ffi::c_int
            | (1 as ::core::ffi::c_int) << (i & (BITVEC_SZELEM - 1 as ::core::ffi::c_int) as u32_0))
            as u8_0;
        return SQLITE_OK;
    ...
    let fresh1 = i;
    i = i.wrapping_add(1);
    h = (fresh1.wrapping_mul(1 as u32_0) as usize).wrapping_rem(BITVEC_NINT) as u32_0;
...
pub unsafe extern "C" fn sqlite3BitvecClear(
    ...
    if (*p).iSize as usize <= BITVEC_NBIT {
        (*p).u.aBitmap[i.wrapping_div(BITVEC_SZELEM as u32_0) as usize] =
            ((*p).u.aBitmap[i.wrapping_div(BITVEC_SZELEM as u32_0) as usize] as ::core::ffi::c_int
                & !(((1 as ::core::ffi::c_int)
                    << (i & (BITVEC_SZELEM - 1 as ::core::ffi::c_int) as u32_0))
                    as u8_0 as ::core::ffi::c_int)) as u8_0;
    } else {
        let mut j: ::core::ffi::c_uint = 0;
...
pub unsafe extern "C" fn sqlite3BitvecBuiltinTest(
    ...
    if sz <= 0 as ::core::ffi::c_int {
        ...
        pV = sqlite3MallocZero(((7 as i64_0 + sz as i64_0) / 8 as i64_0 + 1 as i64_0) as u64_0)
            ...
            if op >= 6 as ::core::ffi::c_int {
                ...
                *fresh2 -= 1;
                ...
                if op & 1 as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
                    ...
                    if sqlite3BitvecSet(pBitvec, (i + 1 as ::core::ffi::c_int) as u32_0) != 0 {
                    ...
                    sqlite3BitvecClear(pBitvec, (i + 1 as ::core::ffi::c_int) as u32_0, pTmpSpace);
                }
            }
        }
        match current_block {
            ...
            _ => {
                if !pV.is_null() {
                    rc = ((sqlite3BitvecTest(::core::ptr::null_mut::<Bitvec>(), 0 as u32_0)
                        + sqlite3BitvecTest(pBitvec, (sz + 1 as ::core::ffi::c_int) as u32_0)
                        + sqlite3BitvecTest(pBitvec, 0 as u32_0))
                        as u32_0)
                        .wrapping_add(sqlite3BitvecSize(pBitvec).wrapping_sub(sz as u32_0))
                        as ::core::ffi::c_int;
