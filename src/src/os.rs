...
pub use crate::sqlite3_h::sqlite3_file;pub use crate::sqlite3_h::sqlite3_filename;pub use crate::src::src::malloc::sqlite3_free;pub use crate::src::src::main::sqlite3_initialize;pub use crate::sqlite3_h::sqlite3_int64;pub use crate::sqlite3_h::sqlite3_io_methods;pub use crate::src::src::malloc::sqlite3_malloc;pub use crate::sqlite3_h::sqlite3_mem_methods;pub use crate::src::src::mutex_unix::sqlite3_mutex;pub use crate::src::src::mutex::sqlite3_mutex_enter;pub use crate::src::src::mutex::sqlite3_mutex_leave;pub use crate::sqlite3_h::sqlite3_mutex_methods;pub use crate::src::src::os_unix::sqlite3_os_init;pub use crate::sqlite3_h::sqlite3_pcache;pub use crate::sqlite3_h::sqlite3_pcache_methods2;pub use crate::sqlite3_h::sqlite3_pcache_page;pub use crate::sqlite3_h::sqlite3_syscall_ptr;pub use crate::sqlite3_h::sqlite3_vfs;pub use crate::sqlite3_h::sqlite_int64;pub use crate::sqlite3_h::sqlite_uint64;pub use crate::sqlite3_h::SQLITE_FCNTL_CKPT_DONE;pub use crate::sqlite3_h::SQLITE_FCNTL_CKPT_START;pub use crate::sqlite3_h::SQLITE_FCNTL_COMMIT_PHASETWO;pub use crate::sqlite3_h::SQLITE_FCNTL_LOCK_TIMEOUT;pub use crate::sqlite3_h::SQLITE_IOERR;pub use crate::sqlite3_h::SQLITE_IOERR_NOMEM;pub use crate::sqlite3_h::SQLITE_MUTEX_STATIC_MAIN;pub use crate::sqlite3_h::SQLITE_NOMEM;pub use crate::sqlite3_h::SQLITE_NOTFOUND;pub use crate::sqlite3_h::SQLITE_OK;pub use crate::src::ext::rtree::rtree::i64_0;pub use crate::src::src::global::sqlite3Config;pub use crate::src::src::memjournal::sqlite3JournalIsInMemory;pub use crate::src::src::malloc::sqlite3Malloc;pub use crate::src::src::malloc::sqlite3MallocZero;pub use crate::src::src::mutex::sqlite3MutexAlloc;pub use crate::src::ext::rtree::rtree::u32_0;pub use crate::src::ext::rtree::rtree::u64_0;pub use crate::src::ext::rtree::rtree::u8_0;pub use crate::sqliteInt_h::Sqlite3Config;pub use crate::sqliteInt_h::SQLITE_IOERR_NOMEM_BKPT;pub use crate::sqliteInt_h::SQLITE_NOMEM_BKPT;pub use crate::stdlib::uint32_t;pub use crate::stdlib::uint8_t;pub use crate::stdlib::__uint32_t;pub use crate::stdlib::__uint8_t;
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3OsClose(mut pId: *mut crate::sqlite3_h::sqlite3_file) {
    if !(*pId).pMethods.is_null() {
        (*(*pId).pMethods)
            .xClose
            .expect("non-null function pointer")(pId);
        (*pId).pMethods = ::core::ptr::null::<crate::sqlite3_h::sqlite3_io_methods>();
    }
}
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3OsRead(
    ...
    if sqlite3_memdebug_vfs_oom_test != 0 && (id.is_null() || crate::src::src::memjournal::sqlite3JournalIsInMemory(id as *mut crate::sqlite3_h::sqlite3_file) == 0) {
    ...
    return (*(*id).pMethods).xRead.expect("non-null function pointer")(
        ...
        pBuf,
        amt,
        offset as crate::sqlite3_h::sqlite3_int64,
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3OsTruncate(
    ...
    return (*(*id).pMethods)
        .xTruncate
        .expect("non-null function pointer")(id, size as crate::sqlite3_h::sqlite3_int64);
}
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3OsFileSize(
    ...
    return (*(*id).pMethods)
        .xFileSize
        .expect("non-null function pointer")(id, pSize as *mut crate::sqlite3_h::sqlite3_int64);
}
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3OsFileControl(
    ...
    if op != crate::sqlite3_h::SQLITE_FCNTL_COMMIT_PHASETWO
        && op != crate::sqlite3_h::SQLITE_FCNTL_LOCK_TIMEOUT
        && op != crate::sqlite3_h::SQLITE_FCNTL_CKPT_DONE
        && op != crate::sqlite3_h::SQLITE_FCNTL_CKPT_START
    {
        if sqlite3_memdebug_vfs_oom_test != 0 && (id.is_null() || crate::src::src::memjournal::sqlite3JournalIsInMemory(id as *mut crate::sqlite3_h::sqlite3_file) == 0)
        {
            let mut pTstAlloc: *mut ::core::ffi::c_void = crate::src::src::malloc::sqlite3Malloc(10 as crate::src::ext::rtree::rtree::u64_0);
...
pub unsafe extern "C" fn sqlite3OsSectorSize(mut id: *mut crate::sqlite3_h::sqlite3_file) -> ::core::ffi::c_int {
    let mut xSectorSize: Option<unsafe extern "C" fn(*mut crate::sqlite3_h::sqlite3_file) -> ::core::ffi::c_int> =
...
pub unsafe extern "C" fn sqlite3OsShmBarrier(mut id: *mut crate::sqlite3_h::sqlite3_file) {
    (*(*id).pMethods)
        .xShmBarrier
        .expect("non-null function pointer")(id);
}
...
pub unsafe extern "C" fn sqlite3OsFetch(
    ...
    return (*(*id).pMethods).xFetch.expect("non-null function pointer")(
        id,
        iOff as crate::sqlite3_h::sqlite3_int64,
        iAmt,
        pp,
    );
}
...
pub unsafe extern "C" fn sqlite3OsUnfetch(
    ...
    return (*(*id).pMethods)
        .xUnfetch
        .expect("non-null function pointer")(id, iOff as crate::sqlite3_h::sqlite3_int64, p);
}
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3OsOpen(
    ...
    if sqlite3_memdebug_vfs_oom_test != 0
        && (0 as ::core::ffi::c_int == 0
            || crate::src::src::memjournal::sqlite3JournalIsInMemory(::core::ptr::null_mut::<crate::sqlite3_h::sqlite3_file>() as
    *mut crate::sqlite3_h::sqlite3_file) == 0)
    {
        let mut pTstAlloc: *mut ::core::ffi::c_void = crate::src::src::malloc::sqlite3Malloc(10 as crate::src::ext::rtree::rtree::u64_0);
        if pTstAlloc.is_null() {
            return crate::sqliteInt_h::SQLITE_IOERR_NOMEM_BKPT;
...
pub unsafe extern "C" fn sqlite3OsGetLastError(mut pVfs: *mut crate::sqlite3_h::sqlite3_vfs) -> ::core::ffi::c_int {
...
pub unsafe extern "C" fn sqlite3OsCurrentTimeInt64(
    mut pVfs: *mut crate::sqlite3_h::sqlite3_vfs,
    mut pTimeOut: *mut crate::sqlite3_h::sqlite3_int64,
) -> ::core::ffi::c_int {
    let mut rc: ::core::ffi::c_int = 0;
    if (*pVfs).iVersion >= 2 as ::core::ffi::c_int && (*pVfs).xCurrentTimeInt64.is_some() {
        ...
        *pTimeOut = (r * 86400000.0f64) as crate::sqlite3_h::sqlite3_int64;
    }
    return rc;
}
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3OsOpenMalloc(
    ...
    mut ppFile: *mut *mut crate::sqlite3_h::sqlite3_file,
    mut flags: ::core::ffi::c_int,
    ...
    pFile = crate::src::src::malloc::sqlite3MallocZero((*pVfs).szOsFile as crate::src::ext::rtree::rtree::u64_0) as *mut crate::sqlite3_h::sqlite3_file;
    if !pFile.is_null() {
        rc = sqlite3OsOpen(pVfs, zFile, pFile, flags, pOutFlags);
        if rc != crate::sqlite3_h::SQLITE_OK {
            crate::src::src::malloc::sqlite3_free(pFile as *mut ::core::ffi::c_void);
            *ppFile = ::core::ptr::null_mut::<crate::sqlite3_h::sqlite3_file>();
        } else {
            *ppFile = pFile;
        }
    } else {
...
pub unsafe extern "C" fn sqlite3OsCloseFree(mut pFile: *mut crate::sqlite3_h::sqlite3_file) {
...
pub unsafe extern "C" fn sqlite3OsInit() -> ::core::ffi::c_int {
    ...
    return crate::src::src::os_unix::sqlite3_os_init();
}

static mut vfsList: *mut crate::sqlite3_h::sqlite3_vfs = ::core::ptr::null::<crate::sqlite3_h::sqlite3_vfs>() as *mut crate::sqlite3_h::sqlite3_vfs;
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3_vfs_find(
    ...
    if rc != 0 {
        return ::core::ptr::null_mut::<crate::sqlite3_h::sqlite3_vfs>();
    }
    mutex = crate::src::src::mutex::sqlite3MutexAlloc(crate::sqlite3_h::SQLITE_MUTEX_STATIC_MAIN);
...
unsafe extern "C" fn vfsUnlink(mut pVfs: *mut crate::sqlite3_h::sqlite3_vfs) {
    if !pVfs.is_null() {
        if vfsList == pVfs {
            vfsList = (*pVfs).pNext;
        } else if !vfsList.is_null() {
            let mut p: *mut crate::sqlite3_h::sqlite3_vfs = vfsList;
...
pub unsafe extern "C" fn sqlite3_vfs_unregister(mut pVfs: *mut crate::sqlite3_h::sqlite3_vfs) -> ::core::ffi::c_int {
    let mut mutex: *mut crate::src::src::mutex_unix::sqlite3_mutex = ::core::ptr::null_mut::<crate::src::src::mutex_unix::sqlite3_mutex>();
    let mut rc: ::core::ffi::c_int = crate::src::src::main::sqlite3_initialize();
    if rc != 0 {
        return rc;
