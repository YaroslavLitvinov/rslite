...
pub unsafe extern "C" fn sqlite3_get_table(
    ...
    *fresh1 = res.nData as intptr_t as *mut ::core::ffi::c_void as *mut ::core::ffi::c_char;
...
pub unsafe extern "C" fn sqlite3_free_table(mut azResult: *mut *mut ::core::ffi::c_char) {
    if !azResult.is_null() {
        ...
        n = *azResult.offset(0 as ::core::ffi::c_int as isize) as intptr_t as ::core::ffi::c_int;
        i = 1 as ::core::ffi::c_int;
        while i < n {
            if !(*azResult.offset(i as isize)).is_null() {
                sqlite3_free(*azResult.offset(i as isize) as *mut ::core::ffi::c_void);
            }
            i += 1;
        }
