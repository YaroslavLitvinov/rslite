...
pub unsafe extern "C" fn sqlite3VdbeExpandSql(
    ...
    let mut out: StrAccum = sqlite3_str {
    ...
    let mut utf8: Mem = sqlite3_value {
        u: MemValue { r: 0. },
    ...
    if (*db).nVdbeExec > 1 as ::core::ffi::c_int {
        ...
        while *zRawSql.offset(0 as ::core::ffi::c_int as isize) != 0 {
            ...
            if *zRawSql.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '?' as i32
            {
                ...
                idx = sqlite3VdbeParameterIndex(p, zRawSql, nToken as ::core::ffi::c_int);
            }
            ...
            pVar = (*p).aVar.offset((idx - 1 as ::core::ffi::c_int) as isize) as *mut Mem;
            if (*pVar).flags as ::core::ffi::c_int & MEM_Null != 0 {
            ...
            } else if (*pVar).flags as ::core::ffi::c_int & (MEM_Int | MEM_IntReal) != 0 {
                sqlite3_str_appendf(
                    &raw mut out,
                ...
                if enc as ::core::ffi::c_int != SQLITE_UTF8 {
                    ...
                    if SQLITE_NOMEM == sqlite3VdbeChangeEncoding(&raw mut utf8, SQLITE_UTF8) {
