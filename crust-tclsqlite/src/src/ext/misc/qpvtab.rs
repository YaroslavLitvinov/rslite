...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct qpvtab_vtab {
    pub base: sqlite3_vtab,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct qpvtab_cursor {
    pub base: sqlite3_vtab_cursor,
    pub iRowid: sqlite3_int64,
    pub zData: *const ::core::ffi::c_char,
...
static mut azColname: [*const ::core::ffi::c_char; 13] = [
    b"vn\0".as_ptr() as *const ::core::ffi::c_char,
    b"ix\0".as_ptr() as *const ::core::ffi::c_char,
    b"cn\0".as_ptr() as *const ::core::ffi::c_char,
    b"op\0".as_ptr() as *const ::core::ffi::c_char,
    b"ux\0".as_ptr() as *const ::core::ffi::c_char,
...
unsafe extern "C" fn qpvtabConnect(
    mut db: *mut sqlite3,
    ...
    unsafe {
        let mut pNew: *mut qpvtab_vtab = ::core::ptr::null_mut::<qpvtab_vtab>();
        let mut rc: ::core::ffi::c_int = 0;
        rc = sqlite3_declare_vtab(
            db,
            b"CREATE TABLE x( vn TEXT, ix INT, cn TEXT, op INT, ux BOOLEAN, rhs TEXT, a, b, c, d, e, flags INT HIDDEN)\0"
                .as_ptr() as *const ::core::ffi::c_char,
        );
        if rc == SQLITE_OK {
            pNew = sqlite3_malloc(
                ::core::mem::size_of::<qpvtab_vtab>() as ::core::ffi::c_int,
            ) as *mut qpvtab_vtab;
            *ppVtab = pNew as *mut sqlite3_vtab;
            ...
            memset(
                ...
                0 as ::core::ffi::c_int,
                ::core::mem::size_of::<qpvtab_vtab>() as size_t,
            );
        }
        return rc;
    }
}
pub const QPVTAB_VN: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
pub const QPVTAB_IX: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
pub const QPVTAB_OP: ::core::ffi::c_int = 3 as ::core::ffi::c_int;
pub const QPVTAB_UX: ::core::ffi::c_int = 4 as ::core::ffi::c_int;
pub const QPVTAB_RHS: ::core::ffi::c_int = 5 as ::core::ffi::c_int;
pub const QPVTAB_A: ::core::ffi::c_int = 6 as ::core::ffi::c_int;
pub const QPVTAB_E: ::core::ffi::c_int = 10 as ::core::ffi::c_int;
pub const QPVTAB_FLAGS: ::core::ffi::c_int = 11 as ::core::ffi::c_int;
pub const QPVTAB_NONE: ::core::ffi::c_int = 12 as ::core::ffi::c_int;
unsafe extern "C" fn qpvtabDisconnect(
    mut pVtab: *mut sqlite3_vtab,
) -> ::core::ffi::c_int {
    unsafe {
        let mut p: *mut qpvtab_vtab = pVtab as *mut qpvtab_vtab;
        sqlite3_free(p as *mut ::core::ffi::c_void);
        return SQLITE_OK;
    }
}
unsafe extern "C" fn qpvtabOpen(
    mut p: *mut sqlite3_vtab,
    mut ppCursor: *mut *mut sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut qpvtab_cursor = ::core::ptr::null_mut::<qpvtab_cursor>();
        pCur = sqlite3_malloc(
            ::core::mem::size_of::<qpvtab_cursor>() as ::core::ffi::c_int,
        ...
        memset(
            ...
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<qpvtab_cursor>() as size_t,
        );
        *ppCursor = &raw mut (*pCur).base;
        return SQLITE_OK;
    }
}
unsafe extern "C" fn qpvtabClose(
    mut cur: *mut sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut qpvtab_cursor = cur as *mut qpvtab_cursor;
        sqlite3_free(pCur as *mut ::core::ffi::c_void);
        return SQLITE_OK;
    }
}
unsafe extern "C" fn qpvtabNext(
    mut cur: *mut sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut qpvtab_cursor = cur as *mut qpvtab_cursor;
        if (*pCur).iRowid < (*pCur).nData as ::core::ffi::c_longlong {
            let mut z: *const ::core::ffi::c_char = (*pCur)
                .zData
                .offset((*pCur).iRowid as isize) as *const ::core::ffi::c_char;
            let mut zEnd: *const ::core::ffi::c_char = strchr(z, '\n' as i32);
            if !zEnd.is_null() {
                zEnd = zEnd.offset(1);
            }
            (*pCur).iRowid = zEnd.offset_from((*pCur).zData) as ::core::ffi::c_long
                as ::core::ffi::c_int as sqlite3_int64;
        }
        return SQLITE_OK;
    }
}
unsafe extern "C" fn qpvtabColumn(
    mut cur: *mut sqlite3_vtab_cursor,
    ...
    unsafe {
        let mut pCur: *mut qpvtab_cursor = cur as *mut qpvtab_cursor;
        if i >= QPVTAB_VN && i <= QPVTAB_RHS
            && (*pCur).iRowid < (*pCur).nData as ::core::ffi::c_longlong
        {
            let mut z: *const ::core::ffi::c_char = (*pCur)
                .zData
                .offset((*pCur).iRowid as isize) as *const ::core::ffi::c_char;
            ...
            j = QPVTAB_VN;
            loop {
                zEnd = strchr(z, if j == QPVTAB_RHS { '\n' as i32 } else { ',' as i32 });
                if j == i || zEnd.is_null() {
                    break;
                }
                z = zEnd.offset(1 as ::core::ffi::c_int as isize);
                j += 1;
            }
            if zEnd == z {
                ...
                sqlite3_result_text64(
                    ctx,
                    z,
                    zEnd.offset_from(z) as ::core::ffi::c_long as sqlite3_uint64,
                    ::core::mem::transmute::<
                        ::libc::intptr_t,
                        Option<unsafe extern "C" fn(*mut ::core::ffi::c_void) -> ()>,
            ...
            if (*pCur).flags & 0x1 as ::core::ffi::c_int != 0 {
                sqlite3_result_int(ctx, i - QPVTAB_A + 1 as ::core::ffi::c_int);
            } else {
                let mut x: ::core::ffi::c_char = ('a' as i32 + i - QPVTAB_A)
                    as ::core::ffi::c_char;
                sqlite3_result_text64(
                    ctx,
                    &raw mut x,
...
unsafe extern "C" fn qpvtabRowid(
    mut cur: *mut sqlite3_vtab_cursor,
...
unsafe extern "C" fn qpvtabEof(mut cur: *mut sqlite3_vtab_cursor) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut qpvtab_cursor = cur as *mut qpvtab_cursor;
        return ((*pCur).iRowid >= (*pCur).nData as ::core::ffi::c_longlong)
            as ::core::ffi::c_int;
    }
}
unsafe extern "C" fn qpvtabFilter(
    ...
    unsafe {
        let mut pCur: *mut qpvtab_cursor = pVtabCursor as *mut qpvtab_cursor;
        (*pCur).iRowid = 0 as sqlite3_int64;
        (*pCur).zData = idxStr;
        (*pCur).nData = strlen(idxStr) as ::core::ffi::c_int;
        (*pCur).flags = idxNum;
        return SQLITE_OK;
    }
}
unsafe extern "C" fn qpvtabStrAppendValue(
    ...
    unsafe {
        match sqlite3_value_type(pVal) {
            ...
            SQLITE_TEXT => {
                ...
                let mut a: *const ::core::ffi::c_char = sqlite3_value_text(pVal)
                ...
                while i < n {
                    let mut c: ::core::ffi::c_char = *a.offset(i as isize);
                    if c as ::core::ffi::c_int == '\n' as i32 {
                        c = ' ' as i32 as ::core::ffi::c_char;
                    }
                    sqlite3_str_append(pStr, &raw mut c, 1 as ::core::ffi::c_int);
            ...
            SQLITE_BLOB => {
                ...
                let mut a_0: *const ::core::ffi::c_uchar = sqlite3_value_blob(pVal)
                    as *const ::core::ffi::c_uchar;
                let mut n_0: ::core::ffi::c_int = sqlite3_value_bytes(pVal);
                sqlite3_str_append(
                    pStr,
                ...
                while i_0 < n_0 {
                    sqlite3_str_appendf(
                        ...
                        *a_0.offset(i_0 as isize) as ::core::ffi::c_int,
                    );
                    i_0 += 1;
                }
                sqlite3_str_append(
...
unsafe extern "C" fn qpvtabBestIndex(
    ...
    unsafe {
        ...
        while i < (*pIdxInfo).nConstraint {
            ...
            let mut iCol: ::core::ffi::c_int = (*(*pIdxInfo)
                ...
                .offset(i as isize))
                .iColumn;
            let mut op: ::core::ffi::c_int = (*(*pIdxInfo)
                .aConstraint
                .offset(i as isize))
                .op as ::core::ffi::c_int;
            if iCol == QPVTAB_FLAGS
                && (*(*pIdxInfo).aConstraint.offset(i as isize)).usable
                    as ::core::ffi::c_int != 0
            {
                pVal = ::core::ptr::null_mut::<sqlite3_value>();
                rc = sqlite3_vtab_rhs_value(pIdxInfo, i, &raw mut pVal);
                if !pVal.is_null() {
                    (*pIdxInfo).idxNum = sqlite3_value_int(pVal);
                    if (*pIdxInfo).idxNum & 0x2 as ::core::ffi::c_int != 0 {
            ...
            sqlite3_str_appendf(
                pStr,
                b"aConstraint,%d,%s,%d,%d,\0".as_ptr() as *const ::core::ffi::c_char,
                i,
                azColname[iCol as usize],
                op,
                (*(*pIdxInfo).aConstraint.offset(i as isize)).usable
                    as ::core::ffi::c_int,
            );
        ...
        i = 0 as ::core::ffi::c_int;
        while i < (*pIdxInfo).nConstraint {
            let mut iCol_0: ::core::ffi::c_int = (*(*pIdxInfo)
                .aConstraint
                .offset(i as isize))
                .iColumn;
            let mut op_0: ::core::ffi::c_int = (*(*pIdxInfo)
                .aConstraint
                .offset(i as isize))
                .op as ::core::ffi::c_int;
            if op_0 == SQLITE_INDEX_CONSTRAINT_LIMIT
                || op_0 == SQLITE_INDEX_CONSTRAINT_OFFSET
            {
                iCol_0 = QPVTAB_NONE;
            }
            if iCol_0 >= QPVTAB_A
            ...
            {
                k += 1;
                (*(*pIdxInfo).aConstraintUsage.offset(i as isize)).argvIndex = k;
                if iCol_0 <= QPVTAB_FLAGS
        ...
        i = 0 as ::core::ffi::c_int;
        while i < (*pIdxInfo).nOrderBy {
            let mut iCol_1: ::core::ffi::c_int = (*(*pIdxInfo)
                .aOrderBy
                .offset(i as isize))
                .iColumn;
            sqlite3_str_appendf(
                ...
                b"aOrderBy,%d,%s,%d,,\n\0".as_ptr() as *const ::core::ffi::c_char,
                i,
                if iCol_1 >= 0 as ::core::ffi::c_int {
                    azColname[iCol_1 as usize]
                } else {
                    b"rowid\0".as_ptr() as *const ::core::ffi::c_char
                },
                (*(*pIdxInfo).aOrderBy.offset(i as isize)).desc as ::core::ffi::c_int,
            );
            i += 1;
        }
        sqlite3_str_appendf(
            pStr,
            b"sqlite3_vtab_distinct,%d,,,,\n\0".as_ptr() as *const ::core::ffi::c_char,
        ...
        sqlite3_str_appendf(
            pStr,
            b"colUsed,%d,,,,\n\0".as_ptr() as *const ::core::ffi::c_char,
            (*pIdxInfo).colUsed as ::core::ffi::c_int,
        );
        (*pIdxInfo).estimatedCost = 10 as ::core::ffi::c_int as ::core::ffi::c_double;
...
static mut qpvtabModule: sqlite3_module = unsafe {
    sqlite3_module {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn sqlite3_qpvtab_init(
    mut db: *mut sqlite3,
    ...
    unsafe {
        ...
        rc = sqlite3_create_module(
            db,
            b"qpvtab\0".as_ptr() as *const ::core::ffi::c_char,
            &raw mut qpvtabModule,
