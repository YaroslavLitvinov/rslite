...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct closure_vtab {
    pub base: sqlite3_vtab,
    pub zDb: *mut ::core::ffi::c_char,
    pub zSelf: *mut ::core::ffi::c_char,
    pub zTableName: *mut ::core::ffi::c_char,
    pub zIdColumn: *mut ::core::ffi::c_char,
    pub zParentColumn: *mut ::core::ffi::c_char,
    pub db: *mut sqlite3,
    pub nCursor: ::core::ffi::c_int,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct closure_cursor {
    pub base: sqlite3_vtab_cursor,
    pub pVtab: *mut closure_vtab,
    pub zTableName: *mut ::core::ffi::c_char,
    pub zIdColumn: *mut ::core::ffi::c_char,
    pub zParentColumn: *mut ::core::ffi::c_char,
    pub pCurrent: *mut closure_avl,
    pub pClosure: *mut closure_avl,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct closure_avl {
    pub id: sqlite3_int64,
    pub iGeneration: ::core::ffi::c_int,
    pub pList: *mut closure_avl,
    pub pBefore: *mut closure_avl,
    pub pAfter: *mut closure_avl,
    pub pUp: *mut closure_avl,
    pub height: ::core::ffi::c_short,
    pub imbalance: ::core::ffi::c_short,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct closure_queue {
    pub pFirst: *mut closure_avl,
    pub pLast: *mut closure_avl,
}
...
unsafe extern "C" fn closureAvlRecomputeHeight(mut p: *mut closure_avl) {
    unsafe {
...
unsafe extern "C" fn closureAvlRotateBefore(
    mut pP: *mut closure_avl,
) -> *mut closure_avl {
    unsafe {
        let mut pB: *mut closure_avl = (*pP).pBefore;
        let mut pY: *mut closure_avl = (*pB).pAfter;
        (*pB).pUp = (*pP).pUp;
        (*pB).pAfter = pP;
        (*pP).pUp = pB;
        (*pP).pBefore = pY;
...
unsafe extern "C" fn closureAvlRotateAfter(
    mut pP: *mut closure_avl,
) -> *mut closure_avl {
    unsafe {
        let mut pA: *mut closure_avl = (*pP).pAfter;
        let mut pY: *mut closure_avl = (*pA).pBefore;
        (*pA).pUp = (*pP).pUp;
        (*pA).pBefore = pP;
        (*pP).pUp = pA;
        (*pP).pAfter = pY;
...
unsafe extern "C" fn closureAvlFromPtr(
    mut p: *mut closure_avl,
    mut pp: *mut *mut closure_avl,
) -> *mut *mut closure_avl {
    unsafe {
        let mut pUp: *mut closure_avl = (*p).pUp;
        if pUp.is_null() {
            return pp;
        }
        if (*pUp).pAfter == p {
...
unsafe extern "C" fn closureAvlBalance(mut p: *mut closure_avl) -> *mut closure_avl {
    unsafe {
        let mut pTop: *mut closure_avl = p;
        let mut pp: *mut *mut closure_avl = ::core::ptr::null_mut::<*mut closure_avl>();
        while !p.is_null() {
            closureAvlRecomputeHeight(p);
            if (*p).imbalance as ::core::ffi::c_int >= 2 as ::core::ffi::c_int {
                let mut pB: *mut closure_avl = (*p).pBefore;
                if ((*pB).imbalance as ::core::ffi::c_int) < 0 as ::core::ffi::c_int {
                    (*p).pBefore = closureAvlRotateAfter(pB);
                }
                pp = closureAvlFromPtr(p, &raw mut p);
                *pp = closureAvlRotateBefore(p);
                p = *pp;
            } else if (*p).imbalance as ::core::ffi::c_int <= -2 as ::core::ffi::c_int {
                let mut pA: *mut closure_avl = (*p).pAfter;
                if (*pA).imbalance as ::core::ffi::c_int > 0 as ::core::ffi::c_int {
                    (*p).pAfter = closureAvlRotateBefore(pA);
                }
                pp = closureAvlFromPtr(p, &raw mut p);
                *pp = closureAvlRotateAfter(p);
                p = *pp;
            }
            pTop = p;
            p = (*p).pUp;
...
unsafe extern "C" fn closureAvlSearch(
    mut p: *mut closure_avl,
    mut id: sqlite3_int64,
) -> *mut closure_avl {
    unsafe {
        while !p.is_null() && id != (*p).id {
            p = if id < (*p).id { (*p).pBefore } else { (*p).pAfter };
        }
        return p;
    }
}
unsafe extern "C" fn closureAvlFirst(mut p: *mut closure_avl) -> *mut closure_avl {
    unsafe {
        if !p.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn closureAvlNext(mut p: *mut closure_avl) -> *mut closure_avl {
    unsafe {
        let mut pPrev: *mut closure_avl = ::core::ptr::null_mut::<closure_avl>();
        while !p.is_null() && (*p).pAfter == pPrev {
            pPrev = p;
            p = (*p).pUp;
        }
        if !p.is_null() && pPrev.is_null() {
            p = closureAvlFirst((*p).pAfter);
        }
        return p;
    }
}
unsafe extern "C" fn closureAvlInsert(
    mut ppHead: *mut *mut closure_avl,
    mut pNew: *mut closure_avl,
) -> *mut closure_avl {
    unsafe {
        let mut p: *mut closure_avl = *ppHead;
        if p.is_null() {
            p = pNew;
            (*pNew).pUp = ::core::ptr::null_mut::<closure_avl>();
        } else {
            while !p.is_null() {
                if (*pNew).id < (*p).id {
        ...
        (*pNew).pBefore = ::core::ptr::null_mut::<closure_avl>();
        (*pNew).pAfter = ::core::ptr::null_mut::<closure_avl>();
        (*pNew).height = 1 as ::core::ffi::c_short;
        (*pNew).imbalance = 0 as ::core::ffi::c_short;
        *ppHead = closureAvlBalance(p);
        return ::core::ptr::null_mut::<closure_avl>();
    }
}
unsafe extern "C" fn closureAvlDestroy(
    mut p: *mut closure_avl,
    mut xDestroy: Option<unsafe extern "C" fn(*mut closure_avl) -> ()>,
) {
    unsafe {
        if !p.is_null() {
...
unsafe extern "C" fn queuePush(
    mut pQueue: *mut closure_queue,
    mut pNode: *mut closure_avl,
) {
    unsafe {
        (*pNode).pList = ::core::ptr::null_mut::<closure_avl>();
        if !(*pQueue).pLast.is_null() {
...
unsafe extern "C" fn queuePull(mut pQueue: *mut closure_queue) -> *mut closure_avl {
    unsafe {
        let mut p: *mut closure_avl = (*pQueue).pFirst;
        if !p.is_null() {
            (*pQueue).pFirst = (*p).pList;
            if (*pQueue).pFirst.is_null() {
                (*pQueue).pLast = ::core::ptr::null_mut::<closure_avl>();
            }
        }
        return p;
    }
}
unsafe extern "C" fn closureDequote(
...
unsafe extern "C" fn closureFree(mut p: *mut closure_vtab) {
    unsafe {
        if !p.is_null() {
            ...
            sqlite3_free((*p).zIdColumn as *mut ::core::ffi::c_void);
            sqlite3_free((*p).zParentColumn as *mut ::core::ffi::c_void);
            memset(
                p as *mut ::core::ffi::c_void,
                0 as ::core::ffi::c_int,
                ::core::mem::size_of::<closure_vtab>() as size_t,
            );
            sqlite3_free(p as *mut ::core::ffi::c_void);
        }
    }
}
unsafe extern "C" fn closureDisconnect(
    mut pVtab: *mut sqlite3_vtab,
) -> ::core::ffi::c_int {
    unsafe {
        let mut p: *mut closure_vtab = pVtab as *mut closure_vtab;
        closureFree(p);
        return SQLITE_OK;
    }
}
unsafe extern "C" fn closureValueOfKey(
...
unsafe extern "C" fn closureConnect(
    mut db: *mut sqlite3,
    ...
    unsafe {
        ...
        let mut pNew: *mut closure_vtab = ::core::ptr::null_mut::<closure_vtab>();
        ...
        *ppVtab = ::core::ptr::null_mut::<sqlite3_vtab>();
        pNew = sqlite3_malloc(
            ::core::mem::size_of::<closure_vtab>() as ::core::ffi::c_int,
        ) as *mut closure_vtab;
        if pNew.is_null() {
            return SQLITE_NOMEM;
        }
        ...
        if !(*pNew).zDb.is_null() {
            ...
            if !(*pNew).zSelf.is_null() {
                ...
                loop {
                    if !(i < argc) {
                        c2rust_current_block = 14818589718467733107;
                        break;
                    }
                    zVal = closureValueOfKey(
                        b"tablename\0".as_ptr() as *const ::core::ffi::c_char,
                        *argv.offset(i as isize),
                    );
                    if !zVal.is_null() {
                        sqlite3_free((*pNew).zTableName as *mut ::core::ffi::c_void);
                        (*pNew).zTableName = closureDequote(zVal);
                        if (*pNew).zTableName.is_null() {
                            c2rust_current_block = 12786428260590322032;
                            break;
                        }
                    } else {
                        zVal = closureValueOfKey(
                            b"idcolumn\0".as_ptr() as *const ::core::ffi::c_char,
                            *argv.offset(i as isize),
                        );
                        if !zVal.is_null() {
                            sqlite3_free((*pNew).zIdColumn as *mut ::core::ffi::c_void);
                            (*pNew).zIdColumn = closureDequote(zVal);
                            if (*pNew).zIdColumn.is_null() {
                                c2rust_current_block = 12786428260590322032;
                                break;
                            }
                        } else {
                            zVal = closureValueOfKey(
                                b"parentcolumn\0".as_ptr() as *const ::core::ffi::c_char,
                                *argv.offset(i as isize),
                            );
                            if !zVal.is_null() {
                                sqlite3_free(
                                    (*pNew).zParentColumn as *mut ::core::ffi::c_void,
                                );
                                (*pNew).zParentColumn = closureDequote(zVal);
                                if (*pNew).zParentColumn.is_null() {
                                    c2rust_current_block = 12786428260590322032;
                                    break;
                                }
                            } else {
                ...
                match c2rust_current_block {
                    12786428260590322032 => {}
                    _ => {
                        rc = sqlite3_declare_vtab(
                            db,
                            b"CREATE TABLE x(id,depth,root HIDDEN,tablename HIDDEN,idcolumn HIDDEN,parentcolumn HIDDEN)\0"
...
pub const CLOSURE_COL_ID: ::core::ffi::c_int = 0;
pub const CLOSURE_COL_DEPTH: ::core::ffi::c_int = 1;
pub const CLOSURE_COL_ROOT: ::core::ffi::c_int = 2;
pub const CLOSURE_COL_TABLENAME: ::core::ffi::c_int = 3;
pub const CLOSURE_COL_IDCOLUMN: ::core::ffi::c_int = 4;
pub const CLOSURE_COL_PARENTCOLUMN: ::core::ffi::c_int = 5;
unsafe extern "C" fn closureOpen(
    mut pVTab: *mut sqlite3_vtab,
    mut ppCursor: *mut *mut sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    unsafe {
        let mut p: *mut closure_vtab = pVTab as *mut closure_vtab;
        let mut pCur: *mut closure_cursor = ::core::ptr::null_mut::<closure_cursor>();
        pCur = sqlite3_malloc(
            ::core::mem::size_of::<closure_cursor>() as ::core::ffi::c_int,
        ...
        memset(
            ...
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<closure_cursor>() as size_t,
        );
        (*pCur).pVtab = p;
...
unsafe extern "C" fn closureMemFree(mut p: *mut closure_avl) {
    unsafe {
        sqlite3_free(p as *mut ::core::ffi::c_void);
    }
}
unsafe extern "C" fn closureClearCursor(mut pCur: *mut closure_cursor) {
    unsafe {
        closureAvlDestroy(
            (*pCur).pClosure,
            Some(closureMemFree as unsafe extern "C" fn(*mut closure_avl) -> ()),
        );
        sqlite3_free((*pCur).zTableName as *mut ::core::ffi::c_void);
        sqlite3_free((*pCur).zIdColumn as *mut ::core::ffi::c_void);
        sqlite3_free((*pCur).zParentColumn as *mut ::core::ffi::c_void);
        (*pCur).zTableName = ::core::ptr::null_mut::<::core::ffi::c_char>();
        (*pCur).zIdColumn = ::core::ptr::null_mut::<::core::ffi::c_char>();
        (*pCur).zParentColumn = ::core::ptr::null_mut::<::core::ffi::c_char>();
        (*pCur).pCurrent = ::core::ptr::null_mut::<closure_avl>();
        (*pCur).pClosure = ::core::ptr::null_mut::<closure_avl>();
    }
}
unsafe extern "C" fn closureClose(
    mut cur: *mut sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut closure_cursor = cur as *mut closure_cursor;
...
unsafe extern "C" fn closureNext(
    mut cur: *mut sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut closure_cursor = cur as *mut closure_cursor;
...
unsafe extern "C" fn closureInsertNode(
    mut pQueue: *mut closure_queue,
    mut pCur: *mut closure_cursor,
    mut id: sqlite3_int64,
    mut iGeneration: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pNew: *mut closure_avl = sqlite3_malloc(
            ::core::mem::size_of::<closure_avl>() as ::core::ffi::c_int,
        ) as *mut closure_avl;
        if pNew.is_null() {
            return SQLITE_NOMEM;
        }
        memset(
            pNew as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<closure_avl>() as size_t,
        );
        (*pNew).id = id;
        (*pNew).iGeneration = iGeneration;
        closureAvlInsert(&raw mut (*pCur).pClosure, pNew);
        queuePush(pQueue, pNew);
        return SQLITE_OK;
    }
}
unsafe extern "C" fn closureFilter(
    ...
    unsafe {
        let mut pCur: *mut closure_cursor = pVtabCursor as *mut closure_cursor;
        let mut pVtab: *mut closure_vtab = (*pCur).pVtab;
        let mut iRoot: sqlite3_int64 = 0;
        let mut mxGen: ::core::ffi::c_int = 999999999 as ::core::ffi::c_int;
        let mut zSql: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<
            ::core::ffi::c_char,
        >();
        let mut pStmt: *mut sqlite3_stmt = ::core::ptr::null_mut::<sqlite3_stmt>();
        let mut pAvl: *mut closure_avl = ::core::ptr::null_mut::<closure_avl>();
        let mut rc: ::core::ffi::c_int = SQLITE_OK;
        let mut zTableName: *const ::core::ffi::c_char = (*pVtab).zTableName;
        let mut zIdColumn: *const ::core::ffi::c_char = (*pVtab).zIdColumn;
        let mut zParentColumn: *const ::core::ffi::c_char = (*pVtab).zParentColumn;
        let mut sQueue: closure_queue = closure_queue {
            pFirst: ::core::ptr::null_mut::<closure_avl>(),
            pLast: ::core::ptr::null_mut::<closure_avl>(),
        };
        closureClearCursor(pCur);
        memset(
            &raw mut sQueue as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<closure_queue>() as size_t,
        );
        if idxNum & 1 as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
            return SQLITE_OK;
        }
        iRoot = sqlite3_value_int64(*argv.offset(0 as ::core::ffi::c_int as isize));
        if idxNum & 0xf0 as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
            mxGen = sqlite3_value_int(
                *argv
                    .offset(
                        (idxNum >> 4 as ::core::ffi::c_int & 0xf as ::core::ffi::c_int)
                            as isize,
                    ),
            );
        ...
        if idxNum & 0xf00 as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
            zTableName = sqlite3_value_text(
                *argv
                    .offset(
                        (idxNum >> 8 as ::core::ffi::c_int & 0xf as ::core::ffi::c_int)
                            as isize,
                    ),
            ) as *const ::core::ffi::c_char;
            (*pCur).zTableName = sqlite3_mprintf(
                b"%s\0".as_ptr() as *const ::core::ffi::c_char,
                zTableName,
            );
        }
        if idxNum & 0xf000 as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
            zIdColumn = sqlite3_value_text(
                *argv
                    .offset(
                        (idxNum >> 12 as ::core::ffi::c_int & 0xf as ::core::ffi::c_int)
                            as isize,
                    ),
            ) as *const ::core::ffi::c_char;
            (*pCur).zIdColumn = sqlite3_mprintf(
                b"%s\0".as_ptr() as *const ::core::ffi::c_char,
                zIdColumn,
            );
        }
        if idxNum & 0xf0000 as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
            zParentColumn = sqlite3_value_text(
                *argv
                    .offset(
                        (idxNum >> 16 as ::core::ffi::c_int & 0xf as ::core::ffi::c_int)
                            as isize,
                    ),
            ) as *const ::core::ffi::c_char;
            (*pCur).zParentColumn = sqlite3_mprintf(
                b"%s\0".as_ptr() as *const ::core::ffi::c_char,
                zParentColumn,
            );
        }
        zSql = sqlite3_mprintf(
            b"SELECT \"%w\".\"%w\" FROM \"%w\" WHERE \"%w\".\"%w\"=?1\0".as_ptr()
                as *const ::core::ffi::c_char,
            zTableName,
            zIdColumn,
            zTableName,
        ...
        if zSql.is_null() {
            ...
            if rc != 0 {
                sqlite3_free((*pVtab).base.zErrMsg as *mut ::core::ffi::c_void);
                (*pVtab).base.zErrMsg = sqlite3_mprintf(
                    b"%s\0".as_ptr() as *const ::core::ffi::c_char,
                    sqlite3_errmsg((*pVtab).db),
                );
                return rc;
            }
        }
        if rc == SQLITE_OK {
            rc = closureInsertNode(
                &raw mut sQueue,
                pCur,
                iRoot,
                0 as ::core::ffi::c_int,
        ...
        loop {
            pAvl = queuePull(&raw mut sQueue);
            if pAvl.is_null() {
                break;
            }
            if (*pAvl).iGeneration >= mxGen {
                continue;
            }
            sqlite3_bind_int64(pStmt, 1 as ::core::ffi::c_int, (*pAvl).id);
            while rc == SQLITE_OK && sqlite3_step(pStmt) == SQLITE_ROW {
                if sqlite3_column_type(pStmt, 0 as ::core::ffi::c_int) == SQLITE_INTEGER
                {
                    let mut iNew: sqlite3_int64 = sqlite3_column_int64(
                        pStmt,
                        0 as ::core::ffi::c_int,
                    );
                    if closureAvlSearch((*pCur).pClosure, iNew).is_null() {
                        rc = closureInsertNode(
                            &raw mut sQueue,
                            pCur,
                            iNew,
                            (*pAvl).iGeneration + 1 as ::core::ffi::c_int,
                        );
                    }
                }
            }
...
unsafe extern "C" fn closureColumn(
    mut cur: *mut sqlite3_vtab_cursor,
    ...
    unsafe {
        ...
        match i {
            ...
            CLOSURE_COL_TABLENAME => {
                sqlite3_result_text(
                    ctx,
                    if !(*pCur).zTableName.is_null() {
                        (*pCur).zTableName
                    } else {
                        (*(*pCur).pVtab).zTableName
                    },
                    -1 as ::core::ffi::c_int,
                    ::core::mem::transmute::<
                        ::libc::intptr_t,
            ...
            CLOSURE_COL_IDCOLUMN => {
                sqlite3_result_text(
                    ctx,
                    if !(*pCur).zIdColumn.is_null() {
                        (*pCur).zIdColumn
                    } else {
                        (*(*pCur).pVtab).zIdColumn
                    },
                    -1 as ::core::ffi::c_int,
                    ::core::mem::transmute::<
                        ::libc::intptr_t,
            ...
            CLOSURE_COL_PARENTCOLUMN => {
                sqlite3_result_text(
                    ctx,
                    if !(*pCur).zParentColumn.is_null() {
                        (*pCur).zParentColumn
                    } else {
                        (*(*pCur).pVtab).zParentColumn
                    },
                    -1 as ::core::ffi::c_int,
                    ::core::mem::transmute::<
                        ::libc::intptr_t,
...
unsafe extern "C" fn closureRowid(
    mut cur: *mut sqlite3_vtab_cursor,
    mut pRowid: *mut sqlite_int64,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut closure_cursor = cur as *mut closure_cursor;
        *pRowid = (*(*pCur).pCurrent).id as sqlite_int64;
        return SQLITE_OK;
    }
}
unsafe extern "C" fn closureEof(
    mut cur: *mut sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    unsafe {
        let mut pCur: *mut closure_cursor = cur as *mut closure_cursor;
...
unsafe extern "C" fn closureBestIndex(
    mut pTab: *mut sqlite3_vtab,
    ...
    unsafe {
        ...
        >();
        let mut pVtab: *mut closure_vtab = pTab as *mut closure_vtab;
        let mut rCost: ::core::ffi::c_double = 10000000.0f64;
        ...
        while i < (*pIdxInfo).nConstraint {
            if !((*pConstraint).usable as ::core::ffi::c_int == 0 as ::core::ffi::c_int)
            {
                ...
                if iPlan & 0xf0 as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                    ...
                    && ((*pConstraint).op as ::core::ffi::c_int
                        ...
                        || (*pConstraint).op as ::core::ffi::c_int
                            == SQLITE_INDEX_CONSTRAINT_EQ)
                {
                    iPlan |= idx << 4 as ::core::ffi::c_int;
                    idx += 1;
                    (*(*pIdxInfo).aConstraintUsage.offset(i as isize)).argvIndex = idx;
                    if (*pConstraint).op as ::core::ffi::c_int
                        == SQLITE_INDEX_CONSTRAINT_LT
                    {
                        iPlan |= 0x2 as ::core::ffi::c_int;
                    }
                    rCost /= 5.0f64;
                }
                if iPlan & 0xf00 as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                    && (*pConstraint).iColumn == CLOSURE_COL_TABLENAME
                    && (*pConstraint).op as ::core::ffi::c_int
                        == SQLITE_INDEX_CONSTRAINT_EQ
                {
                    iPlan |= idx << 8 as ::core::ffi::c_int;
                    idx += 1;
                    (*(*pIdxInfo).aConstraintUsage.offset(i as isize)).argvIndex = idx;
                    (*(*pIdxInfo).aConstraintUsage.offset(i as isize)).omit = 1
                        as ::core::ffi::c_uchar;
                ...
                if iPlan & 0xf000 as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                    && (*pConstraint).iColumn == CLOSURE_COL_IDCOLUMN
                    && (*pConstraint).op as ::core::ffi::c_int
                        == SQLITE_INDEX_CONSTRAINT_EQ
                {
                    iPlan |= idx << 12 as ::core::ffi::c_int;
                    idx += 1;
                    (*(*pIdxInfo).aConstraintUsage.offset(i as isize)).argvIndex = idx;
                    (*(*pIdxInfo).aConstraintUsage.offset(i as isize)).omit = 1
                        as ::core::ffi::c_uchar;
                }
                if iPlan & 0xf0000 as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                    && (*pConstraint).iColumn == CLOSURE_COL_PARENTCOLUMN
                    && (*pConstraint).op as ::core::ffi::c_int
                        == SQLITE_INDEX_CONSTRAINT_EQ
                {
                    iPlan |= idx << 16 as ::core::ffi::c_int;
                    idx += 1;
                    (*(*pIdxInfo).aConstraintUsage.offset(i as isize)).argvIndex = idx;
                    (*(*pIdxInfo).aConstraintUsage.offset(i as isize)).omit = 1
                        as ::core::ffi::c_uchar;
        ...
        if (*pVtab).zTableName.is_null()
            && iPlan & 0xf00 as ::core::ffi::c_int == 0 as ::core::ffi::c_int
            || (*pVtab).zIdColumn.is_null()
                && iPlan & 0xf000 as ::core::ffi::c_int == 0 as ::core::ffi::c_int
            || (*pVtab).zParentColumn.is_null()
                && iPlan & 0xf0000 as ::core::ffi::c_int == 0 as ::core::ffi::c_int
        {
            iPlan = 0 as ::core::ffi::c_int;
        }
        if iPlan & 1 as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
            rCost *= 1e30f64;
            i = 0 as ::core::ffi::c_int;
            while i < (*pIdxInfo).nConstraint {
                (*(*pIdxInfo).aConstraintUsage.offset(i as isize)).argvIndex = 0
                    as ::core::ffi::c_int;
                i += 1;
                pConstraint = pConstraint.offset(1);
            }
...
static mut closureModule: sqlite3_module = unsafe {
    sqlite3_module {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn sqlite3_closure_init(
    mut db: *mut sqlite3,
    ...
    unsafe {
        ...
        rc = sqlite3_create_module(
            db,
            b"transitive_closure\0".as_ptr() as *const ::core::ffi::c_char,
            &raw mut closureModule,
