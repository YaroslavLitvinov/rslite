...
unsafe extern "C" fn rememberFunc(
    ...
    unsafe {
        ...
        let mut ptr: *mut sqlite3_int64 = ::core::ptr::null_mut::<sqlite3_int64>();
        v = sqlite3_value_int64(*argv.offset(0 as ::core::ffi::c_int as isize));
        ptr = sqlite3_value_pointer(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn sqlite3_remember_init(
    mut db: *mut sqlite3,
    ...
    unsafe {
        ...
        rc = sqlite3_create_function(
            db,
            b"remember\0".as_ptr() as *const ::core::ffi::c_char,
            2 as ::core::ffi::c_int,
            SQLITE_UTF8,
