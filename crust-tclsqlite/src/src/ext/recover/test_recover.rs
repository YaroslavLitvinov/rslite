...
unsafe extern "C" {
    ...
    fn sqlite3_recover_config(
        _: *mut sqlite3_recover,
        op: ::core::ffi::c_int,
        pArg: *mut ::core::ffi::c_void,
    ) -> ::core::ffi::c_int;
    fn sqlite3_recover_step(_: *mut sqlite3_recover) -> ::core::ffi::c_int;
    fn sqlite3_recover_run(_: *mut sqlite3_recover) -> ::core::ffi::c_int;
    fn sqlite3_recover_errmsg(_: *mut sqlite3_recover) -> *const ::core::ffi::c_char;
    fn sqlite3_recover_errcode(_: *mut sqlite3_recover) -> ::core::ffi::c_int;
    fn sqlite3_recover_finish(_: *mut sqlite3_recover) -> ::core::ffi::c_int;
    fn sprintf(
    ...
    fn Tcl_GetCharLength(objPtr: *mut Tcl_Obj) -> ::core::ffi::c_int;
...
pub const SQLITE_RECOVER_LOST_AND_FOUND: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
pub const SQLITE_RECOVER_FREELIST_CORRUPT: ::core::ffi::c_int = 2 as ::core::ffi::c_int;
pub const SQLITE_RECOVER_ROWIDS: ::core::ffi::c_int = 3 as ::core::ffi::c_int;
pub const SQLITE_RECOVER_SLOWINDEXES: ::core::ffi::c_int = 4 as ::core::ffi::c_int;
...
unsafe extern "C" fn xSqlCallback(
    mut pSqlArg: *mut ::core::ffi::c_void,
    mut zSql: *const ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    unsafe {
        let mut p: *mut TestRecover = pSqlArg as *mut TestRecover;
        let mut pEval: *mut Tcl_Obj = ::core::ptr::null_mut::<Tcl_Obj>();
        let mut res: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
        pEval = Tcl_DuplicateObj((*p).pScript);
        (*pEval).refCount += 1;
        res = Tcl_ListObjAppendElement(
            (*p).interp,
            pEval,
            Tcl_NewStringObj(zSql, -1 as ::core::ffi::c_int),
        );
        if res == TCL_OK {
            res = Tcl_EvalObjEx((*p).interp, pEval, 0 as ::core::ffi::c_int);
        }
        ...
        if res != 0 {
            ...
            let mut pObj: *mut Tcl_Obj = Tcl_GetObjResult((*p).interp);
            if Tcl_GetCharLength(pObj) == 0 as ::core::ffi::c_int {
                res = 0 as ::core::ffi::c_int;
            } else if Tcl_GetIntFromObj((*p).interp, pObj, &raw mut res) != 0 {
                Tcl_BackgroundError((*p).interp);
                return TCL_ERROR;
            }
        }
...
unsafe extern "C" fn testRecoverCmd(
    ...
    unsafe {
        static mut aSub: [RecoverSub; 7] = [
            RecoverSub {
                zSub: b"config\0".as_ptr() as *const ::core::ffi::c_char,
                nArg: 2 as ::core::ffi::c_int,
                zMsg: b"ARG\0".as_ptr() as *const ::core::ffi::c_char,
            },
            RecoverSub {
                zSub: b"run\0".as_ptr() as *const ::core::ffi::c_char,
                nArg: 0 as ::core::ffi::c_int,
                zMsg: b"\0".as_ptr() as *const ::core::ffi::c_char,
            },
            RecoverSub {
                zSub: b"errmsg\0".as_ptr() as *const ::core::ffi::c_char,
                nArg: 0 as ::core::ffi::c_int,
                zMsg: b"\0".as_ptr() as *const ::core::ffi::c_char,
            },
            RecoverSub {
                zSub: b"errcode\0".as_ptr() as *const ::core::ffi::c_char,
                nArg: 0 as ::core::ffi::c_int,
                zMsg: b"\0".as_ptr() as *const ::core::ffi::c_char,
            },
            RecoverSub {
                zSub: b"finish\0".as_ptr() as *const ::core::ffi::c_char,
                nArg: 0 as ::core::ffi::c_int,
                zMsg: b"\0".as_ptr() as *const ::core::ffi::c_char,
            },
            RecoverSub {
                zSub: b"step\0".as_ptr() as *const ::core::ffi::c_char,
                nArg: 0 as ::core::ffi::c_int,
                zMsg: b"\0".as_ptr() as *const ::core::ffi::c_char,
            },
            RecoverSub {
        ...
        let mut pTest: *mut TestRecover = clientData as *mut TestRecover;
        ...
        rc = Tcl_GetIndexFromObjStruct(
            ...
            *objv.offset(1 as ::core::ffi::c_int as isize),
            &raw mut aSub as *mut RecoverSub as *const ::core::ffi::c_void,
            ::core::mem::size_of::<RecoverSub>() as ::core::ffi::c_int,
        ...
        match iSub {
            0 => {
                let mut aOp: [*const ::core::ffi::c_char; 7] = [
                    b"testdb\0".as_ptr() as *const ::core::ffi::c_char,
                    b"lostandfound\0".as_ptr() as *const ::core::ffi::c_char,
                    b"freelistcorrupt\0".as_ptr() as *const ::core::ffi::c_char,
                    b"rowids\0".as_ptr() as *const ::core::ffi::c_char,
                    b"slowindexes\0".as_ptr() as *const ::core::ffi::c_char,
                    b"invalid\0".as_ptr() as *const ::core::ffi::c_char,
                    ::core::ptr::null::<::core::ffi::c_char>(),
                ];
                let mut iOp: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
                let mut res: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
                if Tcl_GetIndexFromObjStruct(
                    interp,
                    *objv.offset(2 as ::core::ffi::c_int as isize),
                    &raw mut aOp as *mut *const ::core::ffi::c_char
                ...
                match iOp {
                    ...
                    1 => {
                        let mut zStr: *const ::core::ffi::c_char = Tcl_GetString(
                            *objv.offset(3 as ::core::ffi::c_int as isize),
                        );
                        res = sqlite3_recover_config(
                            (*pTest).p,
                            SQLITE_RECOVER_LOST_AND_FOUND,
                            (if *zStr.offset(0 as ::core::ffi::c_int as isize)
                                as ::core::ffi::c_int != 0
                            {
                                zStr
                            } else {
                    ...
                    3 => {
                        let mut iVal_0: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
                        if Tcl_GetBooleanFromObj(
                            interp,
                            *objv.offset(3 as ::core::ffi::c_int as isize),
                            &raw mut iVal_0,
                    ...
                    4 => {
                        let mut iVal_1: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
                        if Tcl_GetBooleanFromObj(
                            interp,
                            *objv.offset(3 as ::core::ffi::c_int as isize),
                            &raw mut iVal_1,
                        ...
                        res = sqlite3_recover_config(
                            ...
                            &raw mut iVal_1 as *mut ::core::ffi::c_void,
                        );
                    }
                    5 => {
                        res = sqlite3_recover_config(
            ...
            1 => {
                let mut res_0: ::core::ffi::c_int = sqlite3_recover_run((*pTest).p);
                Tcl_SetObjResult(interp, Tcl_NewIntObj(res_0));
            }
            2 => {
                let mut zErr: *const ::core::ffi::c_char = sqlite3_recover_errmsg(
                    (*pTest).p,
                );
                Tcl_SetObjResult(
                    interp,
            ...
            3 => {
                let mut errCode: ::core::ffi::c_int = sqlite3_recover_errcode(
                    (*pTest).p,
                );
                Tcl_SetObjResult(interp, Tcl_NewIntObj(errCode));
            }
            4 => {
                let mut res_1: ::core::ffi::c_int = sqlite3_recover_errcode((*pTest).p);
                let mut res2: ::core::ffi::c_int = 0;
                if res_1 != SQLITE_OK {
                    let mut zErr_0: *const ::core::ffi::c_char = sqlite3_recover_errmsg(
                        (*pTest).p,
                    );
                    Tcl_SetObjResult(
                        interp,
                        Tcl_NewStringObj(zErr_0, -1 as ::core::ffi::c_int),
                    );
                }
            ...
            5 => {
                let mut res_2: ::core::ffi::c_int = sqlite3_recover_step((*pTest).p);
                Tcl_SetObjResult(interp, Tcl_NewIntObj(res_2));
            }
            _ => {}
        }
        return TCL_OK;
...
unsafe extern "C" fn test_sqlite3_recover_init(
    mut clientData: *mut ::core::ffi::c_void,
    mut interp: *mut Tcl_Interp,
    mut objc: ::core::ffi::c_int,
    mut objv: *const *mut Tcl_Obj,
    ...
    unsafe {
        static mut iTestRecoverCmd: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
        let mut pNew: *mut TestRecover = ::core::ptr::null_mut::<TestRecover>();
        ...
        let mut zUri: *const ::core::ffi::c_char = ::core::ptr::null::<
            ::core::ffi::c_char,
        >();
        let mut zCmd: [::core::ffi::c_char; 128] = [0; 128];
        let mut bSql: ::core::ffi::c_int = if !clientData.is_null() {
            1 as ::core::ffi::c_int
        } else {
            0 as ::core::ffi::c_int
        };
        if objc != 4 as ::core::ffi::c_int {
            let mut zErr: *const ::core::ffi::c_char = if bSql != 0 {
                b"DB DBNAME SCRIPT\0".as_ptr() as *const ::core::ffi::c_char
            } else {
                b"DB DBNAME URI\0".as_ptr() as *const ::core::ffi::c_char
            };
            Tcl_WrongNumArgs(interp, 1 as ::core::ffi::c_int, objv, zErr);
            return TCL_ERROR;
        }
        if getDbPointer(
            interp,
        ...
        pNew = Tcl_Alloc(::core::mem::size_of::<TestRecover>() as ::core::ffi::c_uint)
            as *mut ::core::ffi::c_void as *mut TestRecover;
        if bSql == 0 as ::core::ffi::c_int {
            zUri = Tcl_GetString(*objv.offset(3 as ::core::ffi::c_int as isize));
            (*pNew).p = sqlite3_recover_init(db, zDb, zUri);
        } else {
            (*pNew).interp = interp;
            (*pNew).pScript = *objv.offset(3 as ::core::ffi::c_int as isize);
            (*(*pNew).pScript).refCount += 1;
            (*pNew).p = sqlite3_recover_init_sql(
                db,
                zDb,
                Some(
                    xSqlCallback
        ...
        let c2rust_fresh1 = iTestRecoverCmd;
        iTestRecoverCmd = iTestRecoverCmd + 1;
        sprintf(
            &raw mut zCmd as *mut ::core::ffi::c_char,
            b"sqlite_recover%d\0".as_ptr() as *const ::core::ffi::c_char,
            c2rust_fresh1,
        );
...
unsafe extern "C" fn test_sqlite3_dbdata_init(
    mut clientData: *mut ::core::ffi::c_void,
    mut interp: *mut Tcl_Interp,
    mut objc: ::core::ffi::c_int,
    mut objv: *const *mut Tcl_Obj,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn TestRecover_Init(
    mut interp: *mut Tcl_Interp,
) -> ::core::ffi::c_int {
    unsafe {
        let mut aCmd: [Cmd; 3] = [
            Cmd {
                zCmd: b"sqlite3_recover_init\0".as_ptr() as *const ::core::ffi::c_char,
                xProc: Some(
            ...
            Cmd {
                zCmd: b"sqlite3_recover_init_sql\0".as_ptr()
                ...
                pArg: 1 as ::core::ffi::c_int as *mut ::core::ffi::c_void,
            },
            Cmd {
                zCmd: b"sqlite3_dbdata_init\0".as_ptr() as *const ::core::ffi::c_char,
                xProc: Some(
                    test_sqlite3_dbdata_init
                        as unsafe extern "C" fn(
                            *mut ::core::ffi::c_void,
                            *mut Tcl_Interp,
                            ::core::ffi::c_int,
        ...
        while (i as usize)
            < (::core::mem::size_of::<[Cmd; 3]>() as usize)
