...
unsafe extern "C" fn testDelUser(mut pCtx: *mut ::core::ffi::c_void) {
    unsafe {
        let mut p: *mut BoxGeomCtx = pCtx as *mut BoxGeomCtx;
        Tcl_EvalObjEx((*p).interp, (*p).pScript, 0 as ::core::ffi::c_int);
...
unsafe extern "C" fn invokeTclGeomCb(
    ...
    unsafe {
        ...
        if !(*p).pContext.is_null() {
            let mut aPtr: [::core::ffi::c_char; 64] = [0; 64];
            let mut pCtx: *mut BoxGeomCtx = (*p).pContext as *mut BoxGeomCtx;
            let mut interp: *mut Tcl_Interp = (*pCtx).interp;
            let mut pScript: *mut Tcl_Obj = ::core::ptr::null_mut::<Tcl_Obj>();
            let mut pParam: *mut Tcl_Obj = ::core::ptr::null_mut::<Tcl_Obj>();
            let mut pCoord: *mut Tcl_Obj = ::core::ptr::null_mut::<Tcl_Obj>();
            ...
            sqlite3_snprintf(
                ...
                &raw mut aPtr as *mut ::core::ffi::c_char,
            ...
            while ii < (*p).nParam {
                Tcl_ListObjAppendElement(
                    ...
                    pParam,
                    Tcl_NewDoubleObj(
                        *(*p).aParam.offset(ii as isize) as ::core::ffi::c_double,
                    ),
                );
                ii += 1;
            }
            ...
            while ii < nCoord {
                Tcl_ListObjAppendElement(
                    ...
                    pCoord,
                    Tcl_NewDoubleObj(
                        *aCoord.offset(ii as isize) as ::core::ffi::c_double,
                    ),
                );
                ii += 1;
            }
            ...
            if rc != TCL_OK {
                ...
                let mut nObj: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
                let mut aObj: *mut *mut Tcl_Obj = ::core::ptr::null_mut::<
                    *mut Tcl_Obj,
                >();
                pRes = Tcl_GetObjResult(interp);
                if Tcl_ListObjGetElements(interp, pRes, &raw mut nObj, &raw mut aObj)
                    != 0
                {
                    return TCL_ERROR;
                }
                if nObj > 0 as ::core::ffi::c_int {
                    let mut zCmd: *const ::core::ffi::c_char = Tcl_GetString(
                        *aObj.offset(0 as ::core::ffi::c_int as isize),
                    );
                    ...
                    {
                        *(*p).aParam.offset(0 as ::core::ffi::c_int as isize) = 0.0f64
                    ...
                    {
                        if !(*p).pUser.is_null() || (*p).xDelUser.is_some() {
                            rc = SQLITE_ERROR;
                        } else {
                            let mut pBGCtx: *mut BoxGeomCtx = sqlite3_malloc(
                                ::core::mem::size_of::<BoxGeomCtx>() as ::core::ffi::c_int,
                            ) as *mut BoxGeomCtx;
                            if pBGCtx.is_null() {
                                rc = SQLITE_NOMEM;
                            } else {
                                ...
                                (*p).pUser = pBGCtx as *mut ::core::ffi::c_void;
                                (*p).xDelUser = Some(
                                    testDelUser
                        ...
                        == sqlite3_stricmp(
                            zCmd,
                            b"user_is_zero\0".as_ptr() as *const ::core::ffi::c_char,
                        )
                    {
                        if !(*p).pUser.is_null() || (*p).xDelUser.is_some() {
                            rc = SQLITE_ERROR;
...
unsafe extern "C" fn box_geom(
    ...
    unsafe {
        ...
        if (*p).nParam != nCoord {
            invokeTclGeomCb(
                b"box\0".as_ptr() as *const ::core::ffi::c_char,
                p,
                nCoord,
                aCoord,
            );
        ...
        ii = 0 as ::core::ffi::c_int;
        while ii < nCoord {
            if *aCoord.offset(ii as isize)
                > *(*p).aParam.offset((ii + 1 as ::core::ffi::c_int) as isize)
                || *aCoord.offset((ii + 1 as ::core::ffi::c_int) as isize)
                    < *(*p).aParam.offset(ii as isize)
            {
...
unsafe extern "C" fn register_box_geom(
    ...
    unsafe {
        ...
        let mut pCtx: *mut BoxGeomCtx = ::core::ptr::null_mut::<BoxGeomCtx>();
        let mut aPtr: [::core::ffi::c_char; 64] = [0; 64];
        ...
        pCtx = Tcl_Alloc(
            ::core::mem::size_of::<*mut BoxGeomCtx>() as ::core::ffi::c_uint,
        ) as *mut ::core::ffi::c_void as *mut BoxGeomCtx;
        (*pCtx).interp = interp;
        (*pCtx).pScript = Tcl_DuplicateObj(
            *objv.offset(2 as ::core::ffi::c_int as isize),
        );
        (*(*pCtx).pScript).refCount += 1;
...
unsafe extern "C" fn box_query(
    mut pInfo: *mut sqlite3_rtree_query_info,
) -> ::core::ffi::c_int {
    unsafe {
        let mut azParentWithin: [*const ::core::ffi::c_char; 4] = [
            b"not\0".as_ptr() as *const ::core::ffi::c_char,
            b"partly\0".as_ptr() as *const ::core::ffi::c_char,
            b"fully\0".as_ptr() as *const ::core::ffi::c_char,
            ::core::ptr::null::<::core::ffi::c_char>(),
        ];
        let mut pCtx: *mut BoxQueryCtx = (*pInfo).pContext as *mut BoxQueryCtx;
        let mut interp: *mut Tcl_Interp = (*pCtx).interp;
        let mut pEval: *mut Tcl_Obj = ::core::ptr::null_mut::<Tcl_Obj>();
        let mut pArg: *mut Tcl_Obj = ::core::ptr::null_mut::<Tcl_Obj>();
        let mut pTmp: *mut Tcl_Obj = ::core::ptr::null_mut::<Tcl_Obj>();
        ...
        (*pTmp).refCount += 1;
        ii = 0 as ::core::ffi::c_int;
        while ii < (*pInfo).nParam {
            let mut p: *mut Tcl_Obj = Tcl_NewDoubleObj(
                *(*pInfo).aParam.offset(ii as isize) as ::core::ffi::c_double,
            );
        ...
        Tcl_ListObjAppendElement(
            ...
            pArg,
            Tcl_NewStringObj(
                b"aParam\0".as_ptr() as *const ::core::ffi::c_char,
                -1 as ::core::ffi::c_int,
            ),
        );
        Tcl_ListObjAppendElement(interp, pArg, pTmp);
        let mut _objPtr: *mut Tcl_Obj = pTmp;
        ...
        (*pTmp).refCount += 1;
        ii = 0 as ::core::ffi::c_int;
        while ii < (*pInfo).nCoord {
            let mut p_0: *mut Tcl_Obj = Tcl_NewDoubleObj(
                *(*pInfo).aCoord.offset(ii as isize) as ::core::ffi::c_double,
            );
            Tcl_ListObjAppendElement(interp, pTmp, p_0);
            ii += 1;
        }
        Tcl_ListObjAppendElement(
            interp,
            pArg,
            Tcl_NewStringObj(
                b"aCoord\0".as_ptr() as *const ::core::ffi::c_char,
                -1 as ::core::ffi::c_int,
            ),
        );
        Tcl_ListObjAppendElement(interp, pArg, pTmp);
        let mut _objPtr_0: *mut Tcl_Obj = pTmp;
        let c2rust_fresh2 = (*_objPtr_0).refCount;
        ...
        (*pTmp).refCount += 1;
        ii = 0 as ::core::ffi::c_int;
        while ii <= (*pInfo).mxLevel {
            let mut p_1: *mut Tcl_Obj = Tcl_NewIntObj(
                *(*pInfo).anQueue.offset(ii as isize) as ::core::ffi::c_int,
            );
            Tcl_ListObjAppendElement(interp, pTmp, p_1);
            ii += 1;
        }
        Tcl_ListObjAppendElement(
            interp,
            pArg,
            Tcl_NewStringObj(
                b"anQueue\0".as_ptr() as *const ::core::ffi::c_char,
                -1 as ::core::ffi::c_int,
            ),
        );
        Tcl_ListObjAppendElement(interp, pArg, pTmp);
        let mut _objPtr_1: *mut Tcl_Obj = pTmp;
        let c2rust_fresh3 = (*_objPtr_1).refCount;
        ...
        Tcl_ListObjAppendElement(
            ...
            pArg,
            Tcl_NewStringObj(
                b"iLevel\0".as_ptr() as *const ::core::ffi::c_char,
                -1 as ::core::ffi::c_int,
            ),
        );
        ...
        Tcl_ListObjAppendElement(
            ...
            pArg,
            Tcl_NewStringObj(
                b"mxLevel\0".as_ptr() as *const ::core::ffi::c_char,
                -1 as ::core::ffi::c_int,
            ),
        );
        ...
        Tcl_ListObjAppendElement(
            ...
            pArg,
            Tcl_NewStringObj(
                b"iRowid\0".as_ptr() as *const ::core::ffi::c_char,
                -1 as ::core::ffi::c_int,
            ),
        );
        Tcl_ListObjAppendElement(
            interp,
            pArg,
            Tcl_NewWideIntObj((*pInfo).iRowid as Tcl_WideInt),
        );
        Tcl_ListObjAppendElement(
            interp,
            pArg,
            Tcl_NewStringObj(
                b"rParentScore\0".as_ptr() as *const ::core::ffi::c_char,
                -1 as ::core::ffi::c_int,
            ),
        );
        Tcl_ListObjAppendElement(
            interp,
            pArg,
            Tcl_NewDoubleObj((*pInfo).rParentScore as ::core::ffi::c_double),
        );
        Tcl_ListObjAppendElement(
            interp,
            pArg,
            Tcl_NewStringObj(
                b"eParentWithin\0".as_ptr() as *const ::core::ffi::c_char,
                -1 as ::core::ffi::c_int,
            ),
        );
        Tcl_ListObjAppendElement(
            ...
            pArg,
            Tcl_NewStringObj(
                azParentWithin[(*pInfo).eParentWithin as usize],
                -1 as ::core::ffi::c_int,
            ),
        );
        Tcl_ListObjAppendElement(interp, pEval, pArg);
        rc = if Tcl_EvalObjEx(interp, pEval, 0 as ::core::ffi::c_int) != 0 {
            SQLITE_ERROR
        } else {
            SQLITE_OK
        };
        if rc == SQLITE_OK {
            let mut rScore: ::core::ffi::c_double = 0.0f64;
            let mut nObj: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
            let mut eP: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
            let mut aObj: *mut *mut Tcl_Obj = ::core::ptr::null_mut::<*mut Tcl_Obj>();
            let mut pRes: *mut Tcl_Obj = Tcl_GetObjResult(interp);
            if Tcl_ListObjGetElements(interp, pRes, &raw mut nObj, &raw mut aObj) != 0
                || nObj != 2 as ::core::ffi::c_int
                || Tcl_GetDoubleFromObj(
                    interp,
                    *aObj.offset(1 as ::core::ffi::c_int as isize),
                    &raw mut rScore,
                ) != 0
                || Tcl_GetIndexFromObjStruct(
                    interp,
                    *aObj.offset(0 as ::core::ffi::c_int as isize),
                    &raw mut azParentWithin as *mut *const ::core::ffi::c_char
                ...
                ) != 0
            {
                ...
                (*pInfo).rScore = rScore as sqlite3_rtree_dbl;
                (*pInfo).eParentWithin = eP;
            }
        }
        let mut _objPtr_2: *mut Tcl_Obj = pArg;
        let c2rust_fresh4 = (*_objPtr_2).refCount;
        (*_objPtr_2).refCount = (*_objPtr_2).refCount - 1;
        if c2rust_fresh4 <= 1 as ::core::ffi::c_int {
            TclFreeObj(_objPtr_2);
        }
        let mut _objPtr_3: *mut Tcl_Obj = pEval;
        let c2rust_fresh5 = (*_objPtr_3).refCount;
...
unsafe extern "C" fn box_query_destroy(mut p: *mut ::core::ffi::c_void) {
    unsafe {
        let mut pCtx: *mut BoxQueryCtx = p as *mut BoxQueryCtx;
        let mut _objPtr: *mut Tcl_Obj = (*pCtx).pScript;
...
unsafe extern "C" fn register_box_query(
    mut clientData: *mut ::core::ffi::c_void,
    mut interp: *mut Tcl_Interp,
    mut objc: ::core::ffi::c_int,
    mut objv: *const *mut Tcl_Obj,
    ...
    unsafe {
        let mut db: *mut sqlite3 = ::core::ptr::null_mut::<sqlite3>();
        let mut pCtx: *mut BoxQueryCtx = ::core::ptr::null_mut::<BoxQueryCtx>();
        if objc != 3 as ::core::ffi::c_int {
            Tcl_WrongNumArgs(
                interp,
                1 as ::core::ffi::c_int,
        ...
        pCtx = Tcl_Alloc(::core::mem::size_of::<BoxQueryCtx>() as ::core::ffi::c_uint)
            as *mut ::core::ffi::c_void as *mut BoxQueryCtx;
        (*pCtx).interp = interp;
        (*pCtx).pScript = Tcl_DuplicateObj(
            *objv.offset(2 as ::core::ffi::c_int as isize),
        );
        ...
        sqlite3_rtree_query_callback(
            db,
            b"qbox\0".as_ptr() as *const ::core::ffi::c_char,
            Some(
                box_query
                    as unsafe extern "C" fn(
            ...
            pCtx as *mut ::core::ffi::c_void,
            Some(
                box_query_destroy as unsafe extern "C" fn(*mut ::core::ffi::c_void) -> (),
            ),
        );
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn Sqlitetestrtreedoc_Init(
    mut interp: *mut Tcl_Interp,
) -> ::core::ffi::c_int {
    unsafe {
        Tcl_CreateObjCommand(
            interp,
            b"register_box_geom\0".as_ptr() as *const ::core::ffi::c_char,
            Some(
                register_box_geom
                    as unsafe extern "C" fn(
                        *mut ::core::ffi::c_void,
        ...
        Tcl_CreateObjCommand(
            interp,
            b"register_box_query\0".as_ptr() as *const ::core::ffi::c_char,
            Some(
                register_box_query
                    as unsafe extern "C" fn(
                        *mut ::core::ffi::c_void,
