...
pub struct TestWindow {
    pub xStep: *mut Tcl_Obj,
    pub xFinal: *mut Tcl_Obj,
    pub xValue: *mut Tcl_Obj,
    pub xInverse: *mut Tcl_Obj,
    pub interp: *mut Tcl_Interp,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct TestWindowCtx {
    pub pVal: *mut Tcl_Obj,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
unsafe extern "C" fn doTestWindowStep(
    ...
    unsafe {
        ...
        let mut p: *mut TestWindow = sqlite3_user_data(ctx) as *mut TestWindow;
        let mut pEval: *mut Tcl_Obj = Tcl_DuplicateObj(
            if bInverse != 0 { (*p).xInverse } else { (*p).xStep },
        );
        let mut pCtx: *mut TestWindowCtx = sqlite3_aggregate_context(
            ctx,
            ::core::mem::size_of::<TestWindowCtx>() as ::core::ffi::c_int,
        ) as *mut TestWindowCtx;
        (*pEval).refCount += 1;
        if !pCtx.is_null() {
            let mut zResult: *const ::core::ffi::c_char = ::core::ptr::null::<
                ::core::ffi::c_char,
            >();
            let mut rc: ::core::ffi::c_int = 0;
            if !(*pCtx).pVal.is_null() {
            ...
            while i < nArg {
                ...
                pArg = Tcl_NewStringObj(
                    sqlite3_value_text(*apArg.offset(i as isize))
            ...
            if rc != TCL_OK {
                ...
                sqlite3_result_error(ctx, zResult, -1 as ::core::ffi::c_int);
            } else {
                if !(*pCtx).pVal.is_null() {
                    let mut _objPtr: *mut Tcl_Obj = (*pCtx).pVal;
                ...
                (*(*pCtx).pVal).refCount += 1;
            }
        }
        let mut _objPtr_0: *mut Tcl_Obj = pEval;
...
unsafe extern "C" fn doTestWindowFinalize(
    ...
    unsafe {
        let mut p: *mut TestWindow = sqlite3_user_data(ctx) as *mut TestWindow;
        let mut pEval: *mut Tcl_Obj = Tcl_DuplicateObj(
            if bValue != 0 { (*p).xValue } else { (*p).xFinal },
        );
        let mut pCtx: *mut TestWindowCtx = sqlite3_aggregate_context(
            ctx,
            ::core::mem::size_of::<TestWindowCtx>() as ::core::ffi::c_int,
        ...
        if !pCtx.is_null() {
            ...
            if bValue == 0 as ::core::ffi::c_int {
                ...
                (*pCtx).pVal = ::core::ptr::null_mut::<Tcl_Obj>();
            }
        }
        let mut _objPtr_0: *mut Tcl_Obj = pEval;
...
unsafe extern "C" fn testWindowStep(
    mut ctx: *mut sqlite3_context,
    mut nArg: ::core::ffi::c_int,
    mut apArg: *mut *mut sqlite3_value,
) {
    unsafe {
        doTestWindowStep(0 as ::core::ffi::c_int, ctx, nArg, apArg);
    }
}
unsafe extern "C" fn testWindowInverse(
    mut ctx: *mut sqlite3_context,
    mut nArg: ::core::ffi::c_int,
    mut apArg: *mut *mut sqlite3_value,
) {
    unsafe {
        doTestWindowStep(1 as ::core::ffi::c_int, ctx, nArg, apArg);
    }
}
unsafe extern "C" fn testWindowFinal(mut ctx: *mut sqlite3_context) {
    unsafe {
        doTestWindowFinalize(0 as ::core::ffi::c_int, ctx);
    }
}
unsafe extern "C" fn testWindowValue(mut ctx: *mut sqlite3_context) {
    unsafe {
        doTestWindowFinalize(1 as ::core::ffi::c_int, ctx);
    }
}
unsafe extern "C" fn testWindowDestroy(mut pCtx: *mut ::core::ffi::c_void) {
    unsafe {
        Tcl_Free(pCtx as *mut ::core::ffi::c_char);
    }
}
unsafe extern "C" fn test_create_window(
    ...
    unsafe {
        let mut pNew: *mut TestWindow = ::core::ptr::null_mut::<TestWindow>();
        ...
        if objc != 7 as ::core::ffi::c_int {
            Tcl_WrongNumArgs(
                ...
                1 as ::core::ffi::c_int,
                objv,
                b"DB NAME XSTEP XFINAL XVALUE XINVERSE\0".as_ptr()
                    as *const ::core::ffi::c_char,
            );
            return TCL_ERROR;
        }
        ...
        pNew = Tcl_Alloc(::core::mem::size_of::<TestWindow>() as ::core::ffi::c_uint)
            as *mut ::core::ffi::c_void as *mut TestWindow;
        memset(
            pNew as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<TestWindow>() as size_t,
        );
        (*pNew).xStep = Tcl_DuplicateObj(*objv.offset(3 as ::core::ffi::c_int as isize));
        (*pNew).xFinal = Tcl_DuplicateObj(
            *objv.offset(4 as ::core::ffi::c_int as isize),
        );
        (*pNew).xValue = Tcl_DuplicateObj(
            *objv.offset(5 as ::core::ffi::c_int as isize),
        );
        (*pNew).xInverse = Tcl_DuplicateObj(
            *objv.offset(6 as ::core::ffi::c_int as isize),
        );
        (*pNew).interp = interp;
        (*(*pNew).xStep).refCount += 1;
        (*(*pNew).xFinal).refCount += 1;
        (*(*pNew).xValue).refCount += 1;
        (*(*pNew).xInverse).refCount += 1;
        rc = sqlite3_create_window_function(
            ...
            Some(testWindowFinal as unsafe extern "C" fn(*mut sqlite3_context) -> ()),
            Some(testWindowValue as unsafe extern "C" fn(*mut sqlite3_context) -> ()),
            Some(
                testWindowInverse
                    as unsafe extern "C" fn(
                        *mut sqlite3_context,
            ...
            Some(
                testWindowDestroy as unsafe extern "C" fn(*mut ::core::ffi::c_void) -> (),
            ),
        );
        if rc != SQLITE_OK {
            Tcl_SetObjResult(
...
unsafe extern "C" fn test_create_window_misuse(
    mut clientData: *mut ::core::ffi::c_void,
    mut interp: *mut Tcl_Interp,
    mut objc: ::core::ffi::c_int,
    mut objv: *const *mut Tcl_Obj,
    ...
    unsafe {
        ...
        rc = sqlite3_create_window_function(
            db,
            b"fff\0".as_ptr() as *const ::core::ffi::c_char,
            -1 as ::core::ffi::c_int,
            SQLITE_UTF8,
        ...
        if !(rc != SQLITE_MISUSE) {
            rc = sqlite3_create_window_function(
                ...
                None,
                Some(
                    testWindowValue as unsafe extern "C" fn(*mut sqlite3_context) -> (),
                ),
                Some(
                    testWindowInverse
                        as unsafe extern "C" fn(
        ...
        Tcl_SetObjResult(
            interp,
            Tcl_NewStringObj(
                b"misuse test error\0".as_ptr() as *const ::core::ffi::c_char,
                -1 as ::core::ffi::c_int,
            ),
        );
        return TCL_ERROR;
...
unsafe extern "C" fn sumintStep(
    mut ctx: *mut sqlite3_context,
    mut nArg: ::core::ffi::c_int,
    mut apArg: *mut *mut sqlite3_value,
) {
    unsafe {
        let mut pInt: *mut sqlite3_int64 = ::core::ptr::null_mut::<sqlite3_int64>();
        if sqlite3_value_type(*apArg.offset(0 as ::core::ffi::c_int as isize))
            != SQLITE_INTEGER
        {
        ...
        pInt = sqlite3_aggregate_context(
            ctx,
            ::core::mem::size_of::<sqlite3_int64>() as ::core::ffi::c_int,
        ) as *mut sqlite3_int64;
        if !pInt.is_null() {
            *pInt
                += sqlite3_value_int64(*apArg.offset(0 as ::core::ffi::c_int as isize))
                    as ::core::ffi::c_longlong;
        }
    }
}
unsafe extern "C" fn sumintInverse(
    mut ctx: *mut sqlite3_context,
    mut nArg: ::core::ffi::c_int,
    mut apArg: *mut *mut sqlite3_value,
) {
...
unsafe extern "C" fn sumintFinal(mut ctx: *mut sqlite3_context) {
    unsafe {
        let mut res: sqlite3_int64 = 0 as sqlite3_int64;
        let mut pInt: *mut sqlite3_int64 = ::core::ptr::null_mut::<sqlite3_int64>();
        pInt = sqlite3_aggregate_context(ctx, 0 as ::core::ffi::c_int)
            as *mut sqlite3_int64;
        if !pInt.is_null() {
            res = *pInt;
        }
...
unsafe extern "C" fn sumintValue(mut ctx: *mut sqlite3_context) {
    unsafe {
        let mut res: sqlite3_int64 = 0 as sqlite3_int64;
        let mut pInt: *mut sqlite3_int64 = ::core::ptr::null_mut::<sqlite3_int64>();
        pInt = sqlite3_aggregate_context(ctx, 0 as ::core::ffi::c_int)
...
unsafe extern "C" fn test_create_sumint(
    mut clientData: *mut ::core::ffi::c_void,
    mut interp: *mut Tcl_Interp,
    mut objc: ::core::ffi::c_int,
    mut objv: *const *mut Tcl_Obj,
    ...
    unsafe {
        ...
        rc = sqlite3_create_window_function(
            db,
            b"sumint\0".as_ptr() as *const ::core::ffi::c_char,
            1 as ::core::ffi::c_int,
            SQLITE_UTF8,
            ::core::ptr::null_mut::<::core::ffi::c_void>(),
            Some(
            ...
            Some(sumintFinal as unsafe extern "C" fn(*mut sqlite3_context) -> ()),
            Some(sumintValue as unsafe extern "C" fn(*mut sqlite3_context) -> ()),
            Some(
                sumintInverse
                    as unsafe extern "C" fn(
                        *mut sqlite3_context,
...
unsafe extern "C" fn test_override_sum(
    mut clientData: *mut ::core::ffi::c_void,
    mut interp: *mut Tcl_Interp,
    mut objc: ::core::ffi::c_int,
    mut objv: *const *mut Tcl_Obj,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn Sqlitetest_window_Init(
    mut interp: *mut Tcl_Interp,
) -> ::core::ffi::c_int {
    unsafe {
        static mut aObjCmd: [C2Rust_Unnamed_25; 4] = unsafe {
            [
                C2Rust_Unnamed_25 {
                    zName: b"sqlite3_create_window_function\0".as_ptr()
                ...
                C2Rust_Unnamed_25 {
                    zName: b"test_create_window_function_misuse\0".as_ptr()
                        as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
                    xProc: Some(
                ...
                C2Rust_Unnamed_25 {
                    zName: b"test_create_sumint\0".as_ptr() as *const ::core::ffi::c_char
                ...
                C2Rust_Unnamed_25 {
                    zName: b"test_override_sum\0".as_ptr() as *const ::core::ffi::c_char
                        as *mut ::core::ffi::c_char,
                    xProc: Some(
                        test_override_sum
                            as unsafe extern "C" fn(
        ...
        i = 0 as ::core::ffi::c_int;
        while (i as usize)
            < (::core::mem::size_of::<[C2Rust_Unnamed_25; 4]>() as usize)
