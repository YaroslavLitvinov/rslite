...
unsafe extern "C" fn c_collation_test(
    ...
    unsafe {
        let mut zErrFunction: *const ::core::ffi::c_char = b"N/A\0".as_ptr()
        ...
        if rc != SQLITE_OK {
            zErrFunction = b"sqlite3_open\0".as_ptr() as *const ::core::ffi::c_char;
        } else {
            ...
            if rc != SQLITE_MISUSE {
                sqlite3_close(db);
                zErrFunction = b"sqlite3_create_collation\0".as_ptr()
                    as *const ::core::ffi::c_char;
            } else {
                sqlite3_close(db);
                return TCL_OK;
        ...
        Tcl_AppendResult(
            interp,
            b"Error testing function: \0".as_ptr() as *const ::core::ffi::c_char,
            zErrFunction,
            NULL,
        );
        return TCL_ERROR;
...
unsafe extern "C" fn c_realloc_test(
    mut clientData: ClientData,
    mut interp: *mut Tcl_Interp,
    mut objc: ::core::ffi::c_int,
    mut objv: *const *mut Tcl_Obj,
    ...
    unsafe {
        ...
        p = sqlite3_malloc(5 as ::core::ffi::c_int);
        if p.is_null() {
            zErrFunction = b"sqlite3_malloc\0".as_ptr() as *const ::core::ffi::c_char;
        } else {
            p = sqlite3_realloc(p, -1 as ::core::ffi::c_int);
            if !p.is_null() {
                zErrFunction = b"sqlite3_realloc\0".as_ptr()
                    as *const ::core::ffi::c_char;
            } else {
                return TCL_OK
            }
...
unsafe extern "C" fn c_misuse_test(
    mut clientData: ClientData,
    mut interp: *mut Tcl_Interp,
    mut objc: ::core::ffi::c_int,
    mut objv: *const *mut Tcl_Obj,
    ...
    unsafe {
        ...
        if rc != SQLITE_OK {
            ...
            if rc != SQLITE_MISUSE {
                zErrFunction = b"sqlite3_errcode\0".as_ptr()
                    as *const ::core::ffi::c_char;
            } else {
                pStmt = 1234 as ::core::ffi::c_int as *mut sqlite3_stmt;
                rc = sqlite3_prepare(
                    db,
                ...
                if rc != SQLITE_MISUSE {
                    zErrFunction = b"sqlite3_prepare\0".as_ptr()
                        as *const ::core::ffi::c_char;
                } else {
                    pStmt = 1234 as ::core::ffi::c_int as *mut sqlite3_stmt;
                    ...
                    if rc != SQLITE_MISUSE {
                        zErrFunction = b"sqlite3_prepare_v2\0".as_ptr()
                            as *const ::core::ffi::c_char;
                    } else {
                        pStmt = 1234 as ::core::ffi::c_int as *mut sqlite3_stmt;
                        ...
                        if rc != SQLITE_MISUSE {
                            zErrFunction = b"sqlite3_prepare16\0".as_ptr()
                                as *const ::core::ffi::c_char;
                        } else {
                            pStmt = 1234 as ::core::ffi::c_int as *mut sqlite3_stmt;
                            ...
                            if rc != SQLITE_MISUSE {
                                zErrFunction = b"sqlite3_prepare16_v2\0".as_ptr()
                                    as *const ::core::ffi::c_char;
                            } else {
                                return TCL_OK
                            }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn Sqlitetest9_Init(
    mut interp: *mut Tcl_Interp,
) -> ::core::ffi::c_int {
    unsafe {
        static mut aObjCmd: [C2Rust_Unnamed_25; 3] = unsafe {
            [
                C2Rust_Unnamed_25 {
                    zName: b"c_misuse_test\0".as_ptr() as *const ::core::ffi::c_char
                ...
                C2Rust_Unnamed_25 {
                    zName: b"c_realloc_test\0".as_ptr() as *const ::core::ffi::c_char
                        as *mut ::core::ffi::c_char,
                    xProc: Some(
                        c_realloc_test
                            as unsafe extern "C" fn(
                ...
                C2Rust_Unnamed_25 {
                    zName: b"c_collation_test\0".as_ptr() as *const ::core::ffi::c_char
                        as *mut ::core::ffi::c_char,
                    xProc: Some(
                        c_collation_test
                            as unsafe extern "C" fn(
        ...
        while (i as usize)
            < (::core::mem::size_of::<[C2Rust_Unnamed_25; 3]>() as usize)
