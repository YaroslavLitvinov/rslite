...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn sqlite3BtreeSharedCacheReport(
    ...
    unsafe {
        ...
        while !pBt.is_null() {
            ...
            Tcl_ListObjAppendElement(
                interp,
                pRet,
                Tcl_NewStringObj(zFile, -1 as ::core::ffi::c_int),
            );
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn sqlite3BtreeCursorList(mut p: *mut Btree) {}
